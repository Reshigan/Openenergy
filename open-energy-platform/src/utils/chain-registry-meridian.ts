...
export const MERIDIAN_CHAINS: ChainDescriptor[] = [
  ...
  // W231 — Construction-period IE cost-to-complete (LMA + SARB Dir 7/2018; INVERTED SLA)
  {
    ...
    actions: [
      { action: "request_report", label: "Request monthly report", tone: "primary",
        path: "/api/lender/construction-cost-report/:id/action", method: 'POST', body: { action: "request_report" },
        roles: ["admin", "lender"],
        cascadeHint: "Lender opens reporting cycle; IPP must submit cost-to-complete within SLA window.",
        fields: [{ key: "reason", label: "Reason for report request", type: "evidence" }] },
      { action: "submit_report", label: "Submit construction cost report", tone: "primary",
        path: "/api/lender/construction-cost-report/:id/action", method: 'POST', body: { action: "submit_report" },
        roles: ["admin", "lender", "ipp_developer"],
        cascadeHint: "IPP submits monthly cost-to-complete estimate; lender proceeds to IE review.",
        fields: [{ key: "actual_spend_to_date_zar", label: "Actual spend to date (ZAR)", type: "number", unit: "ZAR" }, { key: "cost_to_complete_estimate_zar", label: "Cost to complete estimate (ZAR)", type: "number", unit: "ZAR" }, { key: "contingency_budget_zar", label: "Contingency budget allocated (ZAR)", type: "number", unit: "ZAR" }, { key: "contingency_spent_zar", label: "Contingency spent to date (ZAR)", type: "number", unit: "ZAR" }, { key: "physical_completion_percentage", label: "Physical completion %", type: "number", unit: "%" }, { key: "revised_completion_date", label: "Revised completion date", type: "date" }, { key: "reason", label: "Report notes", type: "evidence" }] },
      { action: "confirm_cost_overrun", label: "Confirm cost overrun", tone: "primary",
        path: "/api/lender/construction-cost-report/:id/action", method: 'POST', body: { action: "confirm_cost_overrun" },
        roles: ["admin", "lender"],
        cascadeHint: "Cost overrun verified; requires equity injection or standby facility draw. Crosses regulator on large/mega budgets.",
        fields: [{ key: "overrun_zar", label: "Overrun amount (ZAR)", type: "number", unit: "ZAR" }, { key: "overrun_percentage", label: "Overrun as % of budget", type: "number", unit: "%" }, { key: "equity_injection_required_zar", label: "Equity injection required (ZAR)", type: "number", unit: "ZAR" }, { key: "reason", label: "Overrun basis", type: "evidence" }] },
      { action: "draw_standby_facility", label: "Draw standby facility", tone: "primary",
        path: "/api/lender/construction-cost-report/:id/action", method: 'POST', body: { action: "draw_standby_facility" },
        roles: ["admin", "lender"],
        cascadeHint: "Drawdown of pre-arranged standby credit facility to bridge overrun; advances to resolution phase.",
        fields: [{ key: "standby_facility_amount_zar", label: "Standby facility amount drawn (ZAR)", type: "number", unit: "ZAR" }, { key: "reason", label: "Drawdown justification", type: "evidence" }] },
      { action: "confirm_cure", label: "Confirm cure / issue COD", tone: "primary",
        path: "/api/lender/construction-cost-report/:id/action", method: 'POST', body: { action: "confirm_cure" },
        roles: ["admin", "lender"],
        cascadeHint: "Cost overrun resolved through equity injection or facility draw; project moves to operations.",
        fields: [{ key: "revised_completion_date", label: "Actual completion date", type: "date" }, { key: "reason", label: "Cure confirmation notes", type: "evidence" }] },
      { action: "cancel", label: "Cancel monitoring period", tone: "oxide",
        path: "/api/lender/construction-cost-report/:id/action", method: 'POST', body: { action: "cancel" },
        roles: ["admin", "lender"],
        cascadeHint: "Monitoring period closed; no further reporting required.",
        fields: [{ key: "reason", label: "Cancellation reason", type: "evidence", required: true }] },
  ...
  // W223 — CP clearance / financial close (LMA + SARB; INVERTED SLA)
  {
    ...
    eventsTable: null, eventsFk: null,
    actions: [
      { action: "submit_register", label: "Submit CP register", tone: "primary",
        path: "/api/cp-clearances/:id/action", method: 'POST', body: { action: "submit_register" },
        roles: ["admin", "lender", "support"],
        cascadeHint: "CP register transmitted to borrower/advisors for sign-off.",
        fields: [{ key: "reason", label: "Register submission note", type: "evidence" }] },
      { action: "agree_cp_list", label: "Agree CP list", tone: "primary",
        path: "/api/cp-clearances/:id/action", method: 'POST', body: { action: "agree_cp_list" },
        roles: ["admin", "lender", "support"],
        cascadeHint: "All parties confirmed CP list; satisfaction period begins.",
        fields: [{ key: "reason", label: "Agreement confirmation note", type: "evidence" }] },
      { action: "commence_satisfaction", label: "Commence CP satisfaction", tone: "primary",
        path: "/api/cp-clearances/:id/action", method: 'POST', body: { action: "commence_satisfaction" },
        roles: ["admin", "lender", "support"],
        cascadeHint: "Borrower begins active CP satisfaction work; evidence gathering underway.",
        fields: [{ key: "reason", label: "Satisfaction commencement note", type: "evidence" }] },
      { action: "submit_evidence", label: "Submit CP evidence", tone: "primary",
        path: "/api/cp-clearances/:id/action", method: 'POST', body: { action: "submit_evidence" },
        roles: ["admin", "lender", "support"],
        cascadeHint: "Borrower submitted evidence package for lender technical/legal review.",
        fields: [{ key: "reason", label: "Evidence submission note", type: "evidence" }] },
      { action: "waive_cps", label: "Waive CPs", tone: "primary",
        path: "/api/cp-clearances/:id/action", method: 'POST', body: { action: "waive_cps" },
        roles: ["admin", "lender", "support"],
        cascadeHint: "Lender exercised discretion to waive some CPs; borrower advances to drawdown gate.",
        fields: [{ key: "cp_count_satisfied", label: "CPs satisfied", type: "number" }, { key: "cp_count_waived", label: "CPs waived", type: "number" }, { key: "reason", label: "Waiver justification", type: "evidence" }] },
      { action: "withdraw", label: "Withdraw CP clearance", tone: "oxide",
        path: "/api/cp-clearances/:id/action", method: 'POST', body: { action: "withdraw" },
        roles: ["admin", "lender", "support"],
        cascadeHint: "Deal withdrawn before financial close; CP clearance cancelled.",
        fields: [{ key: "reason", label: "Withdrawal reason", type: "evidence", required: true }] },
  ...
  // W195 — ESAP compliance monitoring (IFC PS + EP4; INVERTED SLA)
  {
    ...
    eventsTable: null, eventsFk: null,
    actions: [
      { action: "open_monitoring_period", label: "Open monitoring period", tone: "primary",
        path: "/api/esap-compliance/:id/action", method: 'POST', body: { action: "open_monitoring_period" },
        roles: ["admin", "lender"],
        cascadeHint: "Begin ESAP compliance monitoring cycle; IPP developer enters data collection phase." },
      { action: "submit_data", label: "Submit operational data", tone: "primary",
        path: "/api/esap-compliance/:id/action", method: 'POST', body: { action: "submit_data" },
        roles: ["admin", "lender", "ipp_developer"],
        cascadeHint: "IPP submits E&S operational data; escalates to site verification scheduling." },
      { action: "verify_site", label: "Complete site verification", tone: "primary",
        path: "/api/esap-compliance/:id/action", method: 'POST', body: { action: "verify_site" },
        roles: ["admin", "lender"],
        cascadeHint: "ES Monitor completes on-site verification visit; escalates to draft report preparation." },
      { action: "prepare_draft", label: "Prepare draft report", tone: "primary",
        path: "/api/esap-compliance/:id/action", method: 'POST', body: { action: "prepare_draft" },
        roles: ["admin", "lender"],
        cascadeHint: "Draft monitoring report prepared; escalates to lender internal review." },
      { action: "submit_action_plan", label: "Submit action plan", tone: "primary",
        path: "/api/esap-compliance/:id/action", method: 'POST', body: { action: "submit_action_plan" },
        roles: ["admin", "lender", "ipp_developer"],
        cascadeHint: "IPP submits remediation action plan for major findings; escalates to verification phase.",
        fields: [{ key: "remediation_deadline", label: "Remediation deadline", type: "date" }] },
  ...
  // W214 — E&S action plan (ESAP) monitoring (EP IV + IFC PS1–PS8; INVERTED SLA)
  {
    ...
    eventsTable: null, eventsFk: null,
    actions: [
      { action: "schedule_visit", label: "Schedule site visit", tone: "primary",
        path: "/api/esap-monitoring/:id/action", method: 'POST', body: { action: "schedule_visit" },
        roles: ["admin", "lender", "support"],
        cascadeHint: "Books the initial monitoring visit; initiates the active workflow from esap_issued.",
        fields: [{ key: "visit_scheduled_date", label: "Scheduled visit date", type: "date" }, { key: "auditor_name", label: "Auditor name", type: "string" }] },
      { action: "raise_action", label: "Identify corrective action", tone: "primary",
        path: "/api/esap-monitoring/:id/action", method: 'POST', body: { action: "raise_action" },
        roles: ["admin", "lender", "support"],
        cascadeHint: "Findings from the site visit require borrower corrective action; moves to action_identified state.",
        fields: [{ key: "findings_summary", label: "Findings summary", type: "evidence" }, { key: "finding_count_major", label: "Major findings", type: "number" }, { key: "finding_count_minor", label: "Minor findings", type: "number" }] },
      { action: "submit_cap", label: "Submit corrective action plan", tone: "primary",
        path: "/api/esap-monitoring/:id/action", method: 'POST', body: { action: "submit_cap" },
        roles: ["admin", "lender", "support"],
        cascadeHint: "Borrower submits remediation plan to address identified findings.",
        fields: [{ key: "cap_reference", label: "CAP reference", type: "string" }, { key: "cap_due_date", label: "CAP due date", type: "date" }] },
      { action: "start_remediation", label: "Start remediation", tone: "primary",
        path: "/api/esap-monitoring/:id/action", method: 'POST', body: { action: "start_remediation" },
        roles: ["admin", "lender", "support"],
        cascadeHint: "Borrower begins executing the approved corrective action plan." },
      { action: "record_partial_close", label: "Record partial close", tone: "primary",
        path: "/api/esap-monitoring/:id/action", method: 'POST', body: { action: "record_partial_close" },
        roles: ["admin", "lender", "support"],
        cascadeHint: "Some but not all findings resolved; pauses remediation to track residual actions.",
        fields: [{ key: "tpa_outcome", label: "TPA review outcome", type: "string" }] },
      { action: "withdraw", label: "Withdraw ESAP", tone: "oxide",
        path: "/api/esap-monitoring/:id/action", method: 'POST', body: { action: "withdraw" },
        roles: ["admin", "lender", "support"],
        cascadeHint: "Project decommissioned or loan repaid; terminates the ESAP monitoring chain.",
        fields: [{ key: "reason", label: "Withdrawal reason", type: "evidence" }] },
  ...
  // W194 — Facility amendment & consent (LMA; INVERTED SLA by amendment class)
  {
    ...
    eventsTable: null, eventsFk: null,
    actions: [
      { action: "assess_eligibility", label: "Assess Eligibility", tone: "primary",
        path: "/api/facility-amendments/:id/action", method: 'POST', body: { action: "assess_eligibility" },
        roles: ["admin", "lender", "ipp_developer"],
        cascadeHint: "Evaluates amendment against facility covenants, consent thresholds, and regulatory gating — gates progression to lender circulation.",
        fields: [{ key: "reason", label: "Assessment notes", type: "evidence" }] },
      { action: "record_majority_response", label: "Record Majority Response", tone: "primary",
        path: "/api/facility-amendments/:id/action", method: 'POST', body: { action: "record_majority_response" },
        roles: ["admin", "lender", "ipp_developer"],
        cascadeHint: "Aggregates lender votes after circulation window — either advances to obtain_consent (majority met) or escalate_to_unanimous.",
        fields: [{ key: "reason", label: "Response summary", type: "evidence" }] },
      { action: "escalate_to_unanimous", label: "Escalate to Unanimous",
        path: "/api/facility-amendments/:id/action", method: 'POST', body: { action: "escalate_to_unanimous" },
        roles: ["admin", "lender", "ipp_developer"],
        cascadeHint: "Majority threshold not reached; enters unanimous consent requirement — extends SLA and resets consent deadline.",
        fields: [{ key: "consent_deadline", label: "New unanimous consent deadline", type: "date" }, { key: "reason", label: "Escalation rationale", type: "evidence" }] },
      { action: "prepare_documentation", label: "Prepare Documentation", tone: "primary",
        path: "/api/facility-amendments/:id/action", method: 'POST', body: { action: "prepare_documentation" },
        roles: ["admin", "lender", "ipp_developer"],
        cascadeHint: "Consent obtained — drafts formal amendment docs and execution-ready schedules; gates execute_amendment action.",
        fields: [{ key: "reason", label: "Documentation summary", type: "evidence" }] },
      { action: "lapse_amendment", label: "Lapse Amendment", tone: "oxide",
        path: "/api/facility-amendments/:id/action", method: 'POST', body: { action: "lapse_amendment" },
        roles: ["admin", "lender", "ipp_developer"],
        cascadeHint: "Withdraws amendment proposal due to non-completion, SLA expiry, or changed commercial circumstances — terminal abandonment.",
        fields: [{ key: "reason", label: "Lapse reason", type: "evidence", required: true }] },
  ...
  // Actions hit the generic POST /:id/:action route — underscore segments.
  {
    ...
    actions: [
      { action: "compile_evidence", label: "Compile evidence", tone: "primary",
        path: "/api/stage-gate/:id/compile_evidence", method: 'POST',
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Advances gate from gate_proposed to evidence_compiled state for internal review progression.",
        fields: [{ key: "evidence_payload", label: "Evidence & documentation", type: "evidence" }] },
      { action: "defer_gate", label: "Defer gate",
        path: "/api/stage-gate/:id/defer_gate", method: 'POST',
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Pauses the gate at any non-terminal state (soft pause) — re-enters at evidence_compiled when rescheduled; crosses regulator for mega_capex + equator_cat_a (lender consent required).",
        fields: [{ key: "reason_code", label: "Deferral reason", type: "string" }, { key: "evidence_payload", label: "Evidence / basis", type: "evidence" }] },
      { action: "withdraw_gate", label: "Withdraw gate", tone: "oxide",
        path: "/api/stage-gate/:id/withdraw_gate", method: 'POST',
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Withdraws the project from gating at any non-terminal state — hard-terminal close (sponsor-initiated exit, not a rejection).",
        fields: [{ key: "reason_code", label: "Withdrawal reason", type: "string", required: true }, { key: "evidence_payload", label: "Evidence / basis", type: "evidence" }] },
  ...
  // (no _at suffix); events live in the shared audit_events table, not a per-chain oe_*_events.
  {
    ...
    actions: [
      { action: "set_categories", label: "Set categories", tone: "primary",
        path: "/api/carbon/scope3-disclosure/chain/:id/action", method: 'POST', body: { action: "set_categories" },
        roles: ["admin", "carbon_fund", "support"],
        cascadeHint: "Scope 3 category boundaries identified and scoped; ready for primary data collection.",
        fields: [{ key: "category_count", label: "Category count", type: "number" }, { key: "category_list", label: "Category list (pipe-delimited)", type: "string" }] },
      { action: "open_data_collection", label: "Open data collection", tone: "primary",
        path: "/api/carbon/scope3-disclosure/chain/:id/action", method: 'POST', body: { action: "open_data_collection" },
        roles: ["admin", "carbon_fund", "support"],
        cascadeHint: "Data collection requests sent to value chain partners." },
      { action: "run_calculations", label: "Run calculations", tone: "primary",
        path: "/api/carbon/scope3-disclosure/chain/:id/action", method: 'POST', body: { action: "run_calculations" },
        roles: ["admin", "carbon_fund", "support"],
        cascadeHint: "GHG Protocol calculations executed across all categories." },
      { action: "submit_for_assurance", label: "Submit for assurance", tone: "primary",
        path: "/api/carbon/scope3-disclosure/chain/:id/action", method: 'POST', body: { action: "submit_for_assurance" },
        roles: ["admin", "carbon_fund", "support"],
        cascadeHint: "Submitted to third-party assurance provider for verification.",
        fields: [{ key: "assurance_provider", label: "Assurance provider", type: "string" }, { key: "assurance_standard", label: "Assurance standard (AA1000/ISO 14064-3)", type: "string" }] },
      { action: "issue_limited_assurance", label: "Issue limited assurance", tone: "primary",
        path: "/api/carbon/scope3-disclosure/chain/:id/action", method: 'POST', body: { action: "issue_limited_assurance" },
        roles: ["admin", "carbon_fund", "support"],
        cascadeHint: "Limited assurance opinion issued; may proceed to filing or escalate to reasonable assurance." },
      { action: "qualify_assurance", label: "Qualify assurance", tone: "oxide",
        path: "/api/carbon/scope3-disclosure/chain/:id/action", method: 'POST', body: { action: "qualify_assurance" },
        roles: ["admin", "carbon_fund", "support"],
        cascadeHint: "Material misstatement identified in climate disclosure; crosses regulator inbox automatically.",
        fields: [{ key: "qualified_opinion_reason", label: "Qualification reason", type: "evidence" }] },
  ...
  // nominated imbalance × price × penalty, posted to BRPs; dispute window; URGENT)
  {
    ...
    actions: [
      { action: "receive-meter-data", label: "Receive meter data", tone: "primary",
        path: "/api/grid/imbalance-settlement/chain/:id/receive-meter-data", method: 'POST',
        roles: ["admin", "grid_operator"],
        cascadeHint: "Actual metered MWh recorded; first mandatory step in 14-stage settlement pipeline.",
        fields: [{ key: "metered_mwh", label: "Metered MWh", type: "number" }] },
      { action: "reconcile-nominations", label: "Reconcile nominations", tone: "primary",
        path: "/api/grid/imbalance-settlement/chain/:id/reconcile-nominations", method: 'POST',
        roles: ["admin", "grid_operator"],
        cascadeHint: "Nominated MWh matched against metered; confirms data completeness before compute." },
      { action: "issue-invoice", label: "Issue invoice", tone: "primary",
        path: "/api/grid/imbalance-settlement/chain/:id/issue-invoice", method: 'POST',
        roles: ["admin", "grid_operator"],
        cascadeHint: "Invoice generated and posted to BRP; opens payment window.",
        fields: [{ key: "invoice_number", label: "Invoice number", type: "string" }, { key: "invoice_due_at", label: "Invoice due date", type: "date" }] },
      { action: "acknowledge-invoice", label: "Acknowledge invoice", tone: "primary",
        path: "/api/grid/imbalance-settlement/chain/:id/acknowledge-invoice", method: 'POST',
        roles: ["admin", "grid_operator"],
        cascadeHint: "BRP confirms receipt and understanding of invoice; proceeds to dispute window or payment." },
      { action: "open-dispute-window", label: "Open dispute window", tone: "primary",
        path: "/api/grid/imbalance-settlement/chain/:id/open-dispute-window", method: 'POST',
        roles: ["admin", "grid_operator"],
        cascadeHint: "Dispute window opens (default 7 days); BRP may raise_dispute or proceed to payment_pending.",
        fields: [{ key: "dispute_window_close_at", label: "Dispute window closes at", type: "date" }] },
      { action: "resolve-dispute", label: "Resolve dispute", tone: "primary",
        path: "/api/grid/imbalance-settlement/chain/:id/resolve-dispute", method: 'POST',
        roles: ["admin", "grid_operator"],
        cascadeHint: "Dispute resolution recorded by reviewer; may trigger invoice_revised or return to payment.",
        fields: [{ key: "dispute_resolution_text", label: "Resolution outcome", type: "evidence" }] },
      { action: "revise-invoice", label: "Revise invoice", tone: "primary",
        path: "/api/grid/imbalance-settlement/chain/:id/revise-invoice", method: 'POST',
        roles: ["admin", "grid_operator"],
        cascadeHint: "Invoice recalculated post-dispute (price/quantum changes); re-enters payment cycle with fresh SLA.",
        fields: [{ key: "long_price_zar_per_mwh", label: "Long imbalance price (ZAR/MWh)", type: "number" }, { key: "short_price_zar_per_mwh", label: "Short imbalance price (ZAR/MWh)", type: "number" }, { key: "imbalance_quantum_zar", label: "Imbalance quantum (ZAR)", type: "number" }] },
      { action: "record-payment", label: "Record payment", tone: "primary",
        path: "/api/grid/imbalance-settlement/chain/:id/record-payment", method: 'POST',
        roles: ["admin", "grid_operator"],
        cascadeHint: "Payment received and recorded; clears outstanding balance and advances to settlement.",
        fields: [{ key: "payment_method", label: "Payment method", type: "string" }, { key: "payment_reference", label: "Payment reference", type: "string" }, { key: "amount_paid_zar", label: "Amount paid (ZAR)", type: "number" }] },
      { action: "archive-period", label: "Archive period", tone: "primary",
        path: "/api/grid/imbalance-settlement/chain/:id/archive-period", method: 'POST',
        roles: ["admin", "grid_operator"],
        cascadeHint: "Settled period archived; hard terminal — completes the settlement lifecycle." },
      { action: "cancel-period", label: "Cancel period", tone: "oxide",
        path: "/api/grid/imbalance-settlement/chain/:id/cancel-period", method: 'POST',
        roles: ["admin", "grid_operator"],
        cascadeHint: "Settlement period cancelled (hard terminal); crosses regulator EVERY tier when imbalance_mwh ≠ 0.",
        fields: [{ key: "cancel_reason", label: "Cancellation reason", type: "evidence", required: true }] },
  ...
  // No human ref column or ZAR quantum; affected_mw is the magnitude.
  {
    ...
    eventsTable: null, eventsFk: null,
    actions: [
      { action: "alert_operations_centre", label: "Alert operations centre", tone: "primary",
        path: "/api/eop-activations/:id/action", method: 'POST', body: { action: "alert_operations_centre" },
        roles: ["admin", "grid_operator", "support"],
        cascadeHint: "NTCSA control room and duty managers notified; emergency protocols activated.",
        fields: [{ key: "reason", label: "Alert note", type: "string" }] },
      { action: "assess_load_shedding", label: "Assess load shedding", tone: "primary",
        path: "/api/eop-activations/:id/action", method: 'POST', body: { action: "assess_load_shedding" },
        roles: ["admin", "grid_operator", "support"],
        cascadeHint: "Grid operations assesses required load-shedding stage and demand response; feeds PER.",
        fields: [{ key: "reason", label: "Assessment note", type: "string" }, { key: "load_shedding_stage", label: "Load shedding stage", type: "number" }] },
      { action: "restore_normal_operations", label: "Restore normal operations", tone: "primary",
        path: "/api/eop-activations/:id/action", method: 'POST', body: { action: "restore_normal_operations" },
        roles: ["admin", "grid_operator", "support"],
        cascadeHint: "Grid restored to pre-event baseline; system back to normal frequency and load distribution.",
        fields: [{ key: "reason", label: "Restoration note", type: "string" }, { key: "total_outage_duration_min", label: "Outage duration (minutes)", type: "number" }, { key: "affected_mw", label: "Total affected MW", type: "number", unit: "MW" }] },
      { action: "initiate_per", label: "Initiate post-event review", tone: "primary",
        path: "/api/eop-activations/:id/action", method: 'POST', body: { action: "initiate_per" },
        roles: ["admin", "grid_operator", "support"],
        cascadeHint: "Formal post-event review begins; leads to root-cause analysis and regulatory filing.",
        fields: [{ key: "reason", label: "Review initiation note", type: "string" }, { key: "per_lead_name", label: "PER lead name", type: "string" }] },
      { action: "withdraw", label: "Withdraw activation", tone: "oxide",
        path: "/api/eop-activations/:id/action", method: 'POST', body: { action: "withdraw" },
        roles: ["admin", "grid_operator", "support"],
        cascadeHint: "False alarm or test activation; EOP cancelled without advancing to post-event review.",
        fields: [{ key: "reason", label: "Withdrawal reason", type: "evidence" }] },
  ...
  // USD/MWh — no ZAR quantum column. WRITE {admin, grid_operator} (no support).
  {
    ...
    eventsTable: null, eventsFk: null,
    actions: [
      { action: "submit_to_sapp", label: "Submit to SAPP", tone: "primary",
        path: "/api/grid/interconnector-schedule/:id/action", method: 'POST', body: { action: "submit_to_sapp" },
        roles: ["admin", "grid_operator"],
        cascadeHint: "Schedule submitted to SAPP for review; awaiting bilateral acknowledgement.",
        fields: [{ key: "reason_detail", label: "Submission notes", type: "evidence" }] },
      { action: "sapp_acknowledge", label: "Acknowledge SAPP review", tone: "primary",
        path: "/api/grid/interconnector-schedule/:id/action", method: 'POST', body: { action: "sapp_acknowledge" },
        roles: ["admin", "grid_operator"],
        cascadeHint: "SAPP review complete; counterparty may now submit counter-schedule." },
      { action: "receive_counter_schedule", label: "Receive counter-schedule", tone: "primary",
        path: "/api/grid/interconnector-schedule/:id/action", method: 'POST', body: { action: "receive_counter_schedule" },
        roles: ["admin", "grid_operator"],
        cascadeHint: "Counter-schedule received from SAPP; ready to open bilateral negotiation.",
        fields: [{ key: "reason_detail", label: "Counter-schedule details", type: "evidence" }] },
      { action: "open_negotiation", label: "Open negotiation", tone: "primary",
        path: "/api/grid/interconnector-schedule/:id/action", method: 'POST', body: { action: "open_negotiation" },
        roles: ["admin", "grid_operator"],
        cascadeHint: "Bilateral negotiation commenced; parties may exchange revised schedules.",
        fields: [{ key: "reason_detail", label: "Negotiation parameters", type: "evidence" }] },
      { action: "flag_deviation", label: "Flag deviation",
        path: "/api/grid/interconnector-schedule/:id/action", method: 'POST', body: { action: "flag_deviation" },
        roles: ["admin", "grid_operator"],
        cascadeHint: "Actual flow deviates from schedule; triggers review and dispute workflow.",
        fields: [{ key: "reason_detail", label: "Deviation reason", type: "evidence", required: true }] },
      { action: "resolve_deviation", label: "Resolve deviation", tone: "primary",
        path: "/api/grid/interconnector-schedule/:id/action", method: 'POST', body: { action: "resolve_deviation" },
        roles: ["admin", "grid_operator"],
        cascadeHint: "Deviation resolved; schedule returns to operating status.",
        fields: [{ key: "reason_detail", label: "Resolution", type: "evidence" }] },
      { action: "cancel", label: "Cancel schedule", tone: "oxide",
        path: "/api/grid/interconnector-schedule/:id/action", method: 'POST', body: { action: "cancel" },
        roles: ["admin", "grid_operator"],
        cascadeHint: "Schedule cancelled; terminal state.",
        fields: [{ key: "reason_code", label: "Cancellation code", type: "string" }, { key: "reason_detail", label: "Cancellation reason", type: "evidence", required: true }] },
    ...
    initiation: {
      ...
      fields: [
        ...
        { key: 'neighbour_country', label: 'Neighbour country', type: 'enum', required: true, options: ['ZW', 'MZ', 'BW', 'NA', 'LS', 'SZ', 'ZM'] },
        { key: 'direction', label: 'Direction', type: 'enum', required: true, options: ['export', 'import', 'wheeling'] },
        ...
        { key: 'product_type', label: 'Product type', type: 'enum', required: true, options: ['day_ahead', 'intraday', 'week_ahead', 'bilateral'] },
  ...
  // (asset_number), name, and refurbishment_cost_zar (raw ZAR) for quantum.
  {
    ...
    eventsTable: null, eventsFk: null,
    actions: [
      { action: "start_commissioning", label: "Start commissioning", tone: "primary",
        path: "/api/substation-assets/:id/action", method: 'POST', body: { action: "start_commissioning" },
        roles: ["admin", "grid_operator", "support"],
        cascadeHint: "Asset enters installation and acceptance test phase; SLA clock running.",
        fields: [{ key: "reason", label: "Commissioning notes", type: "evidence" }] },
    ...
    initiation: {
      ...
      fields: [
        ...
        { key: 'asset_type', label: 'Asset type', type: 'enum', options: ['power_transformer', 'auto_transformer', 'instrument_transformer', 'circuit_breaker', 'disconnector', 'busbar', 'cable', 'overhead_line', 'reactor', 'capacitor_bank', 'substation_battery', 'protection_relay'] },
  ...
  // Basel III IFRS 9 + SARB Banks Act §61; INVERTED SLA — systemic = longest)
  {
    ...
    actions: [
      { action: "start-preliminary-assessment", label: "Start preliminary assessment", tone: "primary",
        path: "/api/lender/loan-restructure/chain/:id/start-preliminary-assessment", method: 'POST',
        roles: ["admin", "lender"],
        cascadeHint: "Assessment phase begins — lender evaluates facility for restructure feasibility and relief quantum." },
  ...
  // settlement differential. No human ref column distinct from the CfD contract.
  {
    ...
    eventsTable: null, eventsFk: null,
    actions: [
      { action: "publish_reference_price", label: "Publish reference price", tone: "primary",
        path: "/api/offtaker/virtual-ppa-settlement/:id/action", method: 'POST', body: { action: "publish_reference_price" },
        roles: ["admin", "support"],
        cascadeHint: "Floating reference index published; differential computed and SLA tier derived.",
        fields: [{ key: "reference_price_zar_per_mwh", label: "Reference price (ZAR/MWh)", type: "number", required: true }] },
      { action: "begin_recalculation", label: "Begin recalculation", tone: "primary",
        path: "/api/offtaker/virtual-ppa-settlement/:id/action", method: 'POST', body: { action: "begin_recalculation" },
        roles: ["admin", "support"],
        cascadeHint: "Recalculation initiated following dispute; statement under review." },
      { action: "escalate_to_isda", label: "Escalate to ISDA", tone: "primary",
        path: "/api/offtaker/virtual-ppa-settlement/:id/action", method: 'POST', body: { action: "escalate_to_isda" },
        roles: ["admin", "support"],
        cascadeHint: "Unresolved dispute escalated to ISDA Calculation Agent for binding determination; crosses regulator inbox.",
        fields: [{ key: "isda_determination_ref", label: "ISDA determination reference", type: "string" }] },
      { action: "confirm_recalculation", label: "Confirm recalculation", tone: "primary",
        path: "/api/offtaker/virtual-ppa-settlement/:id/action", method: 'POST', body: { action: "confirm_recalculation" },
        roles: ["admin", "support"],
        cascadeHint: "Recalculation confirmed; revised settlement amount locked and statement ready for reissuance.",
        fields: [{ key: "recalculated_amount_zar", label: "Recalculated settlement amount (ZAR)", type: "number" }] },
      { action: "record_partial_payment", label: "Record partial payment", tone: "primary",
        path: "/api/offtaker/virtual-ppa-settlement/:id/action", method: 'POST', body: { action: "record_partial_payment" },
        roles: ["admin", "support", "offtaker", "ipp_developer"],
        cascadeHint: "Partial payment received; balance remains outstanding and subject to further collection.",
        fields: [{ key: "payment_method", label: "Payment method", type: "string" }, { key: "payment_ref", label: "Payment reference", type: "string" }, { key: "payment_date", label: "Payment date", type: "date" }, { key: "payment_amount_zar", label: "Payment amount (ZAR)", type: "number" }] },
      { action: "cancel", label: "Cancel settlement", tone: "oxide",
        path: "/api/offtaker/virtual-ppa-settlement/:id/action", method: 'POST', body: { action: "cancel" },
        roles: ["admin", "support"],
        cascadeHint: "Settlement statement voided before final settlement; crosses regulator inbox for systemic-tier differentials.",
  ...
  // text. Both write parties share the offtaker community lane convention.
  {
    ...
    eventsTable: null, eventsFk: null,
    actions: [
      { action: "commence_feasibility", label: "Commence feasibility", tone: "primary",
        path: "/api/wheeling-access/:id/action", method: 'POST', body: { action: "commence_feasibility" },
        roles: ["admin", "offtaker", "grid_operator", "support"],
        cascadeHint: "Grid operator begins network capacity assessment; initiates INVERTED SLA countdown.",
        fields: [{ key: "feasibility_ref", label: "Feasibility study reference", type: "string" }, { key: "reason", label: "Reason / notes", type: "evidence" }] },
      { action: "commence_impact_assessment", label: "Commence impact assessment", tone: "primary",
        path: "/api/wheeling-access/:id/action", method: 'POST', body: { action: "commence_impact_assessment" },
        roles: ["admin", "offtaker", "grid_operator", "support"],
        cascadeHint: "Grid operator initiates detailed power-flow study after feasibility is cleared.",
        fields: [{ key: "impact_study_ref", label: "Impact study reference", type: "string" }, { key: "reason", label: "Reason / notes", type: "evidence" }] },
      { action: "commence_negotiation", label: "Commence negotiation", tone: "primary",
        path: "/api/wheeling-access/:id/action", method: 'POST', body: { action: "commence_negotiation" },
        roles: ["admin", "offtaker", "grid_operator", "support"],
        cascadeHint: "Grid operator and offtaker begin commercial and technical terms negotiation.",
        fields: [{ key: "reason", label: "Reason / notes", type: "evidence" }] },
      { action: "request_modification", label: "Request modification",
        path: "/api/wheeling-access/:id/action", method: 'POST', body: { action: "request_modification" },
        roles: ["admin", "offtaker", "grid_operator", "support"],
        cascadeHint: "Active wheeling agreement requires change to capacity or route; opens renegotiation.",
        fields: [{ key: "modification_description", label: "Modification description", type: "evidence" }, { key: "reason", label: "Reason / notes", type: "evidence" }] },
      { action: "flag_renewal", label: "Flag renewal", tone: "primary",
        path: "/api/wheeling-access/:id/action", method: 'POST', body: { action: "flag_renewal" },
        roles: ["admin", "offtaker", "grid_operator", "support"],
        cascadeHint: "Active agreement approaching expiry; triggers renewal negotiation and retermination cycle.",
        fields: [{ key: "renewal_due_date", label: "Renewal due date", type: "date" }, { key: "reason", label: "Reason / notes", type: "evidence" }] },
  ...
  // created_at, so eventsTable stays null until that's reconciled.
  {
    ...
    actions: [
      { action: "acknowledge", label: "Acknowledge",
        path: "/api/esums/wo-chain/:id/acknowledge", method: 'POST',
        roles: ["admin", "support", "om", "esums", "esco"],
        cascadeHint: "Technician confirmed receipt and is ready to depart." },
      { action: "depart", label: "Depart",
        path: "/api/esums/wo-chain/:id/depart", method: 'POST',
        roles: ["admin", "support", "om", "esums", "esco"],
        cascadeHint: "Technician en route to site." },
      { action: "arrive", label: "Arrive",
        path: "/api/esums/wo-chain/:id/arrive", method: 'POST',
        roles: ["admin", "support", "om", "esums", "esco"],
        cascadeHint: "Technician on site and beginning assessment." },
      { action: "diagnose", label: "Diagnose",
        path: "/api/esums/wo-chain/:id/diagnose", method: 'POST',
        roles: ["admin", "support", "om", "esums", "esco"],
        cascadeHint: "Fault root cause identified; repair plan set." },
      { action: "repair", label: "Repair",
        path: "/api/esums/wo-chain/:id/repair", method: 'POST',
        roles: ["admin", "support", "om", "esums", "esco"],
        cascadeHint: "Corrective work underway." },
      { action: "test", label: "Test",
        path: "/api/esums/wo-chain/:id/test", method: 'POST',
        roles: ["admin", "support", "om", "esums", "esco"],
        cascadeHint: "Fix validated and equipment back in service." },
      { action: "complete", label: "Complete",
        path: "/api/esums/wo-chain/:id/complete", method: 'POST',
        roles: ["admin", "support", "om", "esums", "esco"],
        cascadeHint: "Field work finished; awaiting verification." },
      { action: "close", label: "Close", tone: "primary",
        path: "/api/esums/wo-chain/:id/close", method: 'POST',
        roles: ["admin", "support", "om", "esums", "esco"],
        cascadeHint: "Work order terminal; no further transitions allowed." },
  ...
  // safety-critical tightest)
  {
    ...
    actions: [
      { action: "start_rework", label: "Start rework", tone: "primary",
        path: "/api/ipp-ncr/:id/start_rework", method: 'POST',
        roles: ["admin", "ipp_developer", "support"],
        cascadeHint: "Disposition approved; rework/repair/replacement effort begins.",
        fields: [{ key: "rework_scope", label: "Scope of rework", type: "evidence" }, { key: "rework_cost_zar", label: "Estimated cost (ZAR)", type: "number", unit: "ZAR" }, { key: "schedule_impact_days", label: "Schedule impact (days)", type: "number", unit: "days" }] },
      { action: "submit_reinspection", label: "Submit reinspection", tone: "primary",
        path: "/api/ipp-ncr/:id/submit_reinspection", method: 'POST',
        roles: ["admin", "ipp_developer", "support"],
        cascadeHint: "Rework complete; inspection confirms conformance restoration.",
        fields: [{ key: "reinspection_notes", label: "Inspection findings", type: "evidence" }] },
      { action: "plan_corrective_action", label: "Plan corrective action", tone: "primary",
        path: "/api/ipp-ncr/:id/plan_corrective_action", method: 'POST',
        roles: ["admin", "ipp_developer", "support"],
        cascadeHint: "Reinspection passed; preventive measures to prevent future recurrence documented.",
        fields: [{ key: "corrective_action", label: "Corrective action plan", type: "evidence" }, { key: "preventive_action", label: "Preventive action plan", type: "evidence" }, { key: "rca_method", label: "Root cause analysis method", type: "enum", options: ["five_whys", "fishbone", "fmea", "none"] }, { key: "root_cause", label: "Root cause identified", type: "evidence" }] },
      { action: "accept_as_is", label: "Accept as-is", tone: "primary",
        path: "/api/ipp-ncr/:id/accept_as_is", method: 'POST',
        roles: ["admin", "ipp_developer", "support"],
        cascadeHint: "Concession granted; nonconformance accepted without rework. Crosses regulator when IE-notifiable or NERSA-reportable (SIGNATURE).",
        fields: [{ key: "disposition_justification", label: "Justification for acceptance", type: "evidence" }, { key: "ie_comments", label: "Independent Engineer comments", type: "evidence" }] },
      { action: "void_ncr", label: "Void NCR", tone: "oxide",
        path: "/api/ipp-ncr/:id/void_ncr", method: 'POST',
        roles: ["admin", "ipp_developer", "support"],
        cascadeHint: "NCR withdrawn or superseded; terminal exit before investigation complete.",
        fields: [{ key: "closure_notes", label: "Reason for void", type: "evidence" }] },
  ...
  // ── Batch 10 — IPP project_controls + construction ──────────────────────
  {
    ...
    actions: [
      { action: "take_test_samples", label: "Take test samples", tone: "primary",
        path: "/api/ipp-mir/:id/take_test_samples", method: 'POST',
        roles: ["admin", "ipp_developer", "support"],
        cascadeHint: "Material forwarded to lab for testing; advances happy-path acceptance chain.",
        fields: [{ key: "lab_name", label: "Laboratory name", type: "string" }, { key: "lab_sample_ref", label: "Lab sample reference", type: "string" }] },
      { action: "await_results", label: "Await test results", tone: "primary",
        path: "/api/ipp-mir/:id/await_results", method: 'POST',
        roles: ["admin", "ipp_developer", "support"],
        cascadeHint: "Test results received and recorded; held pending approval decision.",
        fields: [{ key: "test_results", label: "Test results", type: "evidence" }, { key: "test_passed", label: "Test passed", type: "boolean" }] },
      { action: "approve_conditional", label: "Approve conditional", tone: "primary",
        path: "/api/ipp-mir/:id/approve_conditional", method: 'POST',
        roles: ["admin", "ipp_developer", "support"],
        cascadeHint: "Conditional approval granted; crosses lender inbox when floor_lender_hold_point set.",
        fields: [{ key: "conditional_notes", label: "Conditional approval notes", type: "evidence" }] },
      { action: "quarantine_material", label: "Quarantine material", tone: "oxide",
        path: "/api/ipp-mir/:id/quarantine_material", method: 'POST',
        roles: ["admin", "ipp_developer", "support"],
        cascadeHint: "Material isolated for safety; crosses regulator inbox when floor_critical_safety set.",
        fields: [{ key: "quarantine_reason", label: "Quarantine reason", type: "evidence", required: true }] },
  ...
  },
  {
    ...
    actions: [
      { action: "complete_induction", label: "Complete induction", tone: "primary",
        path: "/api/ipp-subcontractor/:id/complete_induction", method: 'POST',
        roles: ["admin", "ipp_developer", "support"],
        cascadeHint: "Subcontractor has completed safety induction; ready for site mobilization.",
        fields: [{ key: "notes", label: "Induction notes", type: "string" }] },
      { action: "trigger_review", label: "Trigger performance review", tone: "primary",
        path: "/api/ipp-subcontractor/:id/trigger_review", method: 'POST',
        roles: ["admin", "ipp_developer", "support"],
        cascadeHint: "Work in progress; initiating formal performance & safety review cycle.",
        fields: [{ key: "review_notes", label: "Review rationale", type: "evidence" }] },
      { action: "confirm_good_standing", label: "Confirm good standing", tone: "primary",
        path: "/api/ipp-subcontractor/:id/confirm_good_standing", method: 'POST',
        roles: ["admin", "ipp_developer", "support"],
        cascadeHint: "Performance & safety review passed; subcontractor cleared to resume work.",
        fields: [{ key: "performance_score", label: "Performance score (0–100)", type: "number" }, { key: "review_notes", label: "Review findings", type: "evidence" }] },
      { action: "return_to_performing", label: "Return to performing", tone: "primary",
        path: "/api/ipp-subcontractor/:id/return_to_performing", method: 'POST',
        roles: ["admin", "ipp_developer", "support"],
        cascadeHint: "Good-standing subcontractor resumes active work.",
        fields: [{ key: "notes", label: "Resumption notes", type: "string" }] },
      { action: "demobilize", label: "Demobilize subcontractor", tone: "primary",
        path: "/api/ipp-subcontractor/:id/demobilize", method: 'POST',
        roles: ["admin", "ipp_developer", "support"],
        cascadeHint: "Work complete; subcontractor offboarding and site demobilization initiated.",
        fields: [{ key: "actual_end_date", label: "Site exit date", type: "date" }, { key: "notes", label: "Demobilization notes", type: "string" }] },
      { action: "reinstate_subcontractor", label: "Reinstate subcontractor", tone: "primary",
        path: "/api/ipp-subcontractor/:id/reinstate_subcontractor", method: 'POST',
        roles: ["admin", "ipp_developer", "support"],
        cascadeHint: "Suspended subcontractor conditions resolved; returning to mobilized status.",
        fields: [{ key: "reinstatement_conditions", label: "Reinstatement conditions met", type: "evidence" }] },
  ...
  },
  {
    ...
    actions: [
      { action: "assess-impact", label: "Assess impact", tone: "primary",
        path: "/api/ipp/wbs-schedule/chain/:id/assess-impact", method: 'POST',
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Detailed impact assessment of detected variance; advances to impact_assessed state.",
        fields: [{ key: "current_planned_finish", label: "Revised planned finish date", type: "date" }, { key: "longest_path_duration_days", label: "Critical path duration (days)", type: "number" }, { key: "spi_t", label: "Schedule Performance Index (time-based)", type: "number" }, { key: "narrative", label: "Impact assessment narrative", type: "evidence" }] },
      { action: "propose-recovery", label: "Propose recovery",
        path: "/api/ipp/wbs-schedule/chain/:id/propose-recovery", method: 'POST',
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Recovery plan proposed; stays in impact_assessed state until approved/rejected.",
        fields: [{ key: "recovery_plan_summary", label: "Recovery plan summary", type: "evidence" }, { key: "narrative", label: "Recovery narrative", type: "evidence" }] },
      { action: "mark-recovered", label: "Mark recovered", tone: "primary",
        path: "/api/ipp/wbs-schedule/chain/:id/mark-recovered", method: 'POST',
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Recovery plan executed; advances to recovered state and enables completion.",
        fields: [{ key: "narrative", label: "Recovery completion notes", type: "evidence" }] },
      { action: "resume-schedule", label: "Resume schedule", tone: "primary",
        path: "/api/ipp/wbs-schedule/chain/:id/resume-schedule", method: 'POST',
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Suspended schedule resumed; reverts to in_progress state.",
        fields: [{ key: "narrative", label: "Resume reason", type: "evidence" }] },
      { action: "approve-rebaseline", label: "Approve rebaseline", tone: "primary",
        path: "/api/ipp/wbs-schedule/chain/:id/approve-rebaseline", method: 'POST',
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Rebaseline approved by IPP CEO; signoff recorded and closes the rebaseline gate.",
        fields: [{ key: "narrative", label: "Approval notes", type: "evidence" }] },
      { action: "reject-rebaseline", label: "Reject rebaseline", tone: "oxide",
        path: "/api/ipp/wbs-schedule/chain/:id/reject-rebaseline", method: 'POST',
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Rebaseline rejected; reverts to impact_assessed for revised proposal.",
        fields: [{ key: "narrative", label: "Rejection reason", type: "evidence", required: true }] },
      { action: "mark-late-finish", label: "Mark late finish", tone: "oxide",
        path: "/api/ipp/wbs-schedule/chain/:id/mark-late-finish", method: 'POST',
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Schedule slipped past contractual milestone; HARD terminal with signature regulator crossing EVERY tier when capacity >= 1 MW.",
        fields: [{ key: "late_finish_reason", label: "Late finish reason", type: "evidence", required: true }, { key: "current_planned_finish", label: "Actual finish date", type: "date" }] },
      { action: "suspend-schedule", label: "Suspend schedule", tone: "oxide",
        path: "/api/ipp/wbs-schedule/chain/:id/suspend-schedule", method: 'POST',
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Schedule paused; terminal-ish state; can resume to in_progress. Crosses regulator (mega tier only when critical_path_breach).",
        fields: [{ key: "suspend_reason", label: "Suspension reason", type: "evidence", required: true }, { key: "narrative", label: "Suspension narrative", type: "evidence" }] },
  ...
  },
  {
    ...
    actions: [
      { action: "log-cr", label: "Log change request", tone: "primary",
        path: "/api/ipp/cost-evm/chain/:id/log-cr", method: 'POST',
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Change request logged and entered review cycle; awaiting PM approval or rejection.",
        fields: [{ key: "cr_summary", label: "CR summary", type: "string" }, { key: "cr_value_zar", label: "CR value (ZAR)", type: "number", required: true, unit: "ZAR" }] },
      { action: "approve-cr", label: "Approve change request", tone: "primary",
        path: "/api/ipp/cost-evm/chain/:id/approve-cr", method: 'POST',
        roles: ["admin", "ipp_developer"],
        cascadeHint: "CR approved; crosses regulator inbox if mega tier and CR_value ≥ 10% of total budget.",
        fields: [{ key: "cr_value_zar", label: "CR value (ZAR)", type: "number", unit: "ZAR" }] },
      { action: "reject-reforecast", label: "Reject reforecast", tone: "oxide",
        path: "/api/ipp/cost-evm/chain/:id/reject-reforecast", method: 'POST',
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Reforecast rejected by PM; loops back to reforecast_drafted state with feedback.",
      ...
      { action: "draw-contingency", label: "Draw contingency reserve", tone: "primary",
        path: "/api/ipp/cost-evm/chain/:id/draw-contingency", method: 'POST',
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Contingency reserve drawn and committed to cost book; enters contingency_drawn terminal branch.",
        fields: [{ key: "contingency_drawn_zar", label: "Contingency drawn (ZAR)", type: "number", required: true, unit: "ZAR" }] },
      { action: "submit-to-pm-review", label: "Submit to PM review",
        path: "/api/ipp/cost-evm/chain/:id/submit-to-pm-review", method: 'POST',
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Reforecast submitted to PM for review; remains in reforecast_drafted state pending action." },
      { action: "draw-management-reserve", label: "Draw management reserve", tone: "oxide",
        path: "/api/ipp/cost-evm/chain/:id/draw-management-reserve", method: 'POST',
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Management reserve drawn; EVERY tier crosses regulator (W113 signature board-level cost-overrun event reportable to lenders + IPPO + DMRE).",
        fields: [{ key: "management_reserve_drawn_zar", label: "Management reserve drawn (ZAR)", type: "number", required: true, unit: "ZAR" }] },
  ...
  },
  {
    ...
    actions: [
      { action: "commence_negotiation", label: "Commence negotiation", tone: "primary",
        path: "/api/credit-insurance/:id/action", method: 'POST', body: { action: "commence_negotiation" },
        roles: ["admin", "ipp_developer", "lender", "support"],
        cascadeHint: "Moves the policy into wording negotiation with the insurer." },
      { action: "flag_renewal", label: "Flag renewal", tone: "primary",
        path: "/api/credit-insurance/:id/action", method: 'POST', body: { action: "flag_renewal" },
        roles: ["admin", "ipp_developer", "lender", "support"],
        cascadeHint: "Flags the policy as approaching annual renewal.",
        fields: [{ key: "renewal_due_date", label: "Renewal due date", type: "date" }] },
      { action: "lapse", label: "Lapse", tone: "oxide",
        path: "/api/credit-insurance/:id/action", method: 'POST', body: { action: "lapse" },
        roles: ["admin", "ipp_developer", "lender", "support"],
        cascadeHint: "Policy lapses due to non-payment or expiry — terminal; crosses regulator for project-finance cover.",
        fields: [{ key: "reason", label: "Reason for lapse", type: "evidence" }] },
      { action: "cancel", label: "Cancel", tone: "oxide",
        path: "/api/credit-insurance/:id/action", method: 'POST', body: { action: "cancel" },
        roles: ["admin", "ipp_developer", "lender", "support"],
        cascadeHint: "Cancels the policy by either party — terminal.",
        fields: [{ key: "reason", label: "Cancellation reason", type: "evidence" }] },
  ...
  },
  {
    ...
    eventsTable: null, eventsFk: null,
    actions: [
      { action: "raise_dfi_query", label: "Raise DFI query", tone: "primary",
        path: "/api/dscr-reports/:id/action", method: 'POST', body: { action: "raise_dfi_query" },
        roles: ["admin", "ipp_developer", "lender", "support"],
        cascadeHint: "DFI has identified clarifications needed on DSCR numbers; IPP must respond.",
        fields: [{ key: "dfi_query_details", label: "Query details", type: "evidence" }, { key: "reason", label: "Reason for query", type: "string" }] },
  ...
  },
  {
    ...
    actions: [
      { action: "complete_qs_review", label: "Complete QS review", tone: "primary",
        path: "/api/ipp-progress-claim/:id/complete_qs_review", method: 'POST',
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Quantity surveyor assessment complete; claim advances to PM review.",
        fields: [{ key: "qs_assessed_zar", label: "QS assessed amount (ZAR)", type: "number", unit: "ZAR" }, { key: "qs_notes", label: "QS review notes", type: "evidence" }] },
      { action: "resolve_dispute", label: "Resolve dispute", tone: "primary",
        path: "/api/ipp-progress-claim/:id/resolve_dispute", method: 'POST',
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Dispute resolved; claim returns to PM review for re-assessment.",
        fields: [{ key: "pm_notes", label: "Resolution notes", type: "evidence" }] },
      { action: "reinstate_payment", label: "Reinstate payment", tone: "primary",
        path: "/api/ipp-progress-claim/:id/reinstate_payment", method: 'POST',
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Payment suspension lifted; claim returns to PM review for continued assessment.",
        fields: [{ key: "suspension_reason", label: "Reason for reinstatement", type: "evidence" }] },
      { action: "approve_partial", label: "Approve partial payment", tone: "primary",
        path: "/api/ipp-progress-claim/:id/approve_partial", method: 'POST',
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Partial amount approved; claim enters partial-payment state for settlement.",
        fields: [{ key: "certified_amount_zar", label: "Certified amount (ZAR)", type: "number", unit: "ZAR" }, { key: "engineer_certification_notes", label: "Certification notes", type: "evidence" }] },
      { action: "record_final_account", label: "Record final account", tone: "primary",
        path: "/api/ipp-progress-claim/:id/record_final_account", method: 'POST',
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Final account recorded; claim reaches conclusive settlement — crosses regulator inbox every tier (SIGNATURE)." },
  ...
  },
  {
    ...
    eventsTable: null, eventsFk: null,
    actions: [
      { action: "review_quotation", label: "Review quotation", tone: "primary",
        path: "/api/ipp-variation-order/:id/action", method: 'PUT', body: { action: "review_quotation" },
        roles: ["admin", "ipp_developer"],
        cascadeHint: "IE reviews contractor quotation; quotation_reviewed state gates further negotiation or approval.",
        fields: [{ key: "quotation_notes", label: "Review notes", type: "evidence" }, { key: "instructed_value_zar", label: "Revised value (ZAR)", type: "number", unit: "ZAR" }] },
      { action: "dispute_pricing", label: "Dispute pricing",
        path: "/api/ipp-variation-order/:id/action", method: 'PUT', body: { action: "dispute_pricing" },
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Contractor or party challenges agreed price; opens negotiation or adjudication path.",
        fields: [{ key: "reason", label: "Dispute basis", type: "evidence", required: true }, { key: "instructed_value_zar", label: "Disputed value (ZAR)", type: "number", unit: "ZAR" }] },
      { action: "resolve_dispute", label: "Resolve dispute", tone: "primary",
        path: "/api/ipp-variation-order/:id/action", method: 'PUT', body: { action: "resolve_dispute" },
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Returns disputed order to quotation_reviewed for renegotiation after dispute clarity.",
        fields: [{ key: "reason", label: "Resolution basis", type: "evidence" }, { key: "instructed_value_zar", label: "Resolved value (ZAR)", type: "number", unit: "ZAR" }] },
      { action: "refer_adjudication", label: "Refer to adjudication", tone: "oxide",
        path: "/api/ipp-variation-order/:id/action", method: 'PUT', body: { action: "refer_adjudication" },
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Unresolved dispute referred to adjudicator/DRC; terminal state. Crosses regulator inbox for all tiers.",
        fields: [{ key: "reason", label: "Adjudication grounds", type: "evidence", required: true }] },
  ...
  },
  {
    ...
    eventsTable: null, eventsFk: null,
    actions: [
      { action: "generate_ai_sections", label: "Generate AI sections", tone: "primary",
        path: "/api/carbon/vcm-projects/:id/action", method: 'POST', body: { action: "generate_ai_sections" },
        roles: ["admin", "carbon_fund", "ipp_developer", "support"],
        cascadeHint: "AI generates PDD sections S1, S3, S4, S6 from project metadata; ready for stakeholder review.",
        fields: [{ key: "reason", label: "Reason for generation", type: "evidence" }] },
      { action: "open_stakeholder_consultation", label: "Open stakeholder consultation", tone: "primary",
        path: "/api/carbon/vcm-projects/:id/action", method: 'POST', body: { action: "open_stakeholder_consultation" },
        roles: ["admin", "carbon_fund", "ipp_developer", "support"],
        cascadeHint: "PDD draft complete; opens 30-day public stakeholder comment window per GS4GG/Verra rules.",
        fields: [{ key: "reason", label: "Reason for opening consultation", type: "evidence" }] },
      { action: "submit_preliminary_review", label: "Submit preliminary review", tone: "primary",
        path: "/api/carbon/vcm-projects/:id/action", method: 'POST', body: { action: "submit_preliminary_review" },
        roles: ["admin", "carbon_fund", "ipp_developer", "support"],
        cascadeHint: "Stakeholder consultation closed; submits PDD + comments summary to VVB for validation gate.",
        fields: [{ key: "reason", label: "Submission summary", type: "evidence" }] },
      { action: "commence_implementation", label: "Commence implementation", tone: "primary",
        path: "/api/carbon/vcm-projects/:id/action", method: 'POST', body: { action: "commence_implementation" },
        roles: ["admin", "carbon_fund", "ipp_developer", "support"],
        cascadeHint: "Project registered; begins physical implementation and baseline establishment for monitoring period.",
        fields: [{ key: "reason", label: "Implementation start basis", type: "evidence" }] },
      { action: "open_monitoring_period", label: "Open monitoring period", tone: "primary",
        path: "/api/carbon/vcm-projects/:id/action", method: 'POST', body: { action: "open_monitoring_period" },
        roles: ["admin", "carbon_fund", "ipp_developer", "support"],
        cascadeHint: "Implementation complete; opens continuous monitoring for actual performance reporting and verification.",
        fields: [{ key: "reason", label: "Reason for opening monitoring", type: "evidence" }] },
  ...
  },
  {
    ...
    eventsTable: null, eventsFk: null,
    actions: [
      { action: "submit_coas", label: "Submit COAS", tone: "primary",
        path: "/api/carbon/budget/:id/action", method: 'POST', body: { action: "submit_coas" },
        roles: ["admin", "carbon_fund", "ipp_developer", "support"],
        cascadeHint: "Submits the Certificate of Assessed Savings (DFFE COAS) with retirement references.",
        fields: [{ key: "coas_retirement_refs", label: "COAS retirement refs", type: "string" }] },
      { action: "prepare_sars", label: "Prepare SARS", tone: "primary",
        path: "/api/carbon/budget/:id/action", method: 'POST', body: { action: "prepare_sars" },
        roles: ["admin", "carbon_fund", "ipp_developer", "support"],
        cascadeHint: "Prepares the return for SARS submission with final emissions and offsets." },
      { action: "generate_efiling", label: "Generate eFiling", tone: "primary",
        path: "/api/carbon/budget/:id/action", method: 'POST', body: { action: "generate_efiling" },
        roles: ["admin", "carbon_fund", "ipp_developer", "support"],
        cascadeHint: "Generates the eFiling bundle for submission to SARS." },
      { action: "sars_accept", label: "Accept (SARS)", tone: "primary",
        path: "/api/carbon/budget/:id/action", method: 'POST', body: { action: "sars_accept" },
        roles: ["admin", "carbon_fund", "support"],
        cascadeHint: "SARS accepts the return; large/major tier crosses to regulator inbox." },
      { action: "sars_query", label: "Query (SARS)",
        path: "/api/carbon/budget/:id/action", method: 'POST', body: { action: "sars_query" },
        roles: ["admin", "carbon_fund", "support"],
        cascadeHint: "SARS raises a query on the return; opens respond window.",
        fields: [{ key: "reason", label: "Query reason", type: "evidence" }] },
      { action: "respond_query", label: "Respond to query",
        path: "/api/carbon/budget/:id/action", method: 'POST', body: { action: "respond_query" },
        roles: ["admin", "carbon_fund", "ipp_developer", "support"],
        cascadeHint: "Submits response to SARS query; moves to responded state.",
        fields: [{ key: "reason", label: "Response", type: "evidence" }] },
  ...
  },
  {
    ...
    eventsTable: null, eventsFk: null,
    actions: [
      { action: "lodge_appeal", label: "Lodge appeal", tone: "primary",
        path: "/api/public-consultations/:id/action", method: 'POST', body: { action: "lodge_appeal" },
        roles: ["admin", "regulator"],
        cascadeHint: "Determination under PAJA §6 appeal; regulator and stakeholder notified.",
        fields: [{ key: "appeal_filed_by", label: "Appeal filed by", type: "string" }, { key: "appeal_grounds", label: "Grounds for appeal", type: "evidence" }, { key: "reason", label: "Decision reason", type: "evidence" }] },
      { action: "resolve_appeal", label: "Resolve appeal", tone: "primary",
        path: "/api/public-consultations/:id/action", method: 'POST', body: { action: "resolve_appeal" },
        roles: ["admin", "regulator"],
        cascadeHint: "Appeal concluded; determination finalized and terminal status reached.",
        fields: [{ key: "appeal_outcome", label: "Appeal outcome", type: "enum", options: ["upheld", "dismissed", "settled"] }, { key: "appeal_resolved_at", label: "Resolution date", type: "date" }, { key: "reason", label: "Decision reason", type: "evidence" }] },
    ...
    initiation: {
      ...
      fields: [
        { key: 'title', label: 'Title', type: 'string', required: true },
        { key: 'consultation_type', label: 'Type', type: 'enum', options: ['tariff_determination', 'licence_application', 'licence_amendment', 'code_revision', 'policy_review', 'emergency_determination'] },
        { key: 'consultation_tier', label: 'Tier', type: 'enum', options: ['routine', 'significant', 'national', 'emergency'] },
      ],
    },
  },
  {
    ...
    eventsTable: null, eventsFk: null,
    actions: [
      { action: "documents_received", label: "Documents received", tone: "primary",
        path: "/api/market-conduct-exams/:id/action", method: 'POST', body: { action: "documents_received" },
        roles: ["admin", "regulator", "support"],
        cascadeHint: "Subject has submitted required documentation; examination proceeds to on-site review or preliminary findings." },
      { action: "file_subject_response", label: "File subject response", tone: "primary",
        path: "/api/market-conduct-exams/:id/action", method: 'POST', body: { action: "file_subject_response" },
        roles: ["admin", "regulator", "support"],
        cascadeHint: "Subject has filed response to preliminary findings; regulator proceeds to draft final report.",
        fields: [{ key: "subject_response_ref", label: "Response reference", type: "string" }] },
      { action: "draft_final_report", label: "Draft final report", tone: "primary",
        path: "/api/market-conduct-exams/:id/action", method: 'POST', body: { action: "draft_final_report" },
        roles: ["admin", "regulator", "support"],
        cascadeHint: "Regulator drafts final examination report; subject may provide further comments before issuance or direct to remedial action.",
        fields: [{ key: "findings_summary", label: "Findings summary", type: "evidence" }, { key: "adverse_findings_count", label: "Adverse findings count", type: "number" }] },
      { action: "commence_enforcement", label: "Commence enforcement", tone: "oxide",
        path: "/api/market-conduct-exams/:id/action", method: 'POST', body: { action: "commence_enforcement" },
        roles: ["admin", "regulator", "support"],
        cascadeHint: "Examination findings trigger formal enforcement proceeding; crosses FSCA/NERSA for systemic risk reporting.",
        fields: [{ key: "enforcement_ref", label: "Enforcement reference", type: "string" }, { key: "reason", label: "Enforcement basis", type: "evidence" }] },
    ...
    initiation: {
      ...
      fields: [
        { key: 'exam_type', label: 'Exam type', type: 'enum', options: ['pricing_conduct', 'transparency', 'consumer_protection', 'market_integrity', 'cross_cutting', 'ad_hoc'] },
        { key: 'subject_licence_class', label: 'Subject licence class', type: 'string' },
        { key: 'exam_tier', label: 'Tier', type: 'enum', options: ['routine', 'thematic', 'targeted', 'major_systemic'] },
      ],
    },
  },
  {
    ...
    actions: [
      { action: "plan-tod-test", label: "Plan ToD test", tone: "primary",
        path: "/api/control-environment-audit/:id/plan-tod-test", method: 'POST',
        roles: ["admin"],
        cascadeHint: "Test of Design scope and sample size defined; ready for evidence collection.",
        fields: [{ key: "tod_sample_size", label: "Sample size", type: "number" }] },
      { action: "collect-tod-evidence", label: "Collect ToD evidence", tone: "primary",
        path: "/api/control-environment-audit/:id/collect-tod-evidence", method: 'POST',
        roles: ["admin"],
        cascadeHint: "Test of Design evidence collected; ready for test execution.",
        fields: [{ key: "tod_sample_size", label: "Sample size", type: "number" }] },
      { action: "plan-tooe-test", label: "Plan ToOE test", tone: "primary",
        path: "/api/control-environment-audit/:id/plan-tooe-test", method: 'POST',
        roles: ["admin"],
        cascadeHint: "Test of Operating Effectiveness scope and sample size defined; ready for evidence collection.",
        fields: [{ key: "tooe_sample_size", label: "Sample size", type: "number" }] },
      { action: "collect-tooe-evidence", label: "Collect ToOE evidence", tone: "primary",
        path: "/api/control-environment-audit/:id/collect-tooe-evidence", method: 'POST',
        roles: ["admin"],
        cascadeHint: "Test of Operating Effectiveness evidence collected; ready for test execution.",
        fields: [{ key: "tooe_sample_size", label: "Sample size", type: "number" }] },
      { action: "accept-with-exception", label: "Accept with exception",
        path: "/api/control-environment-audit/:id/accept-with-exception", method: 'POST',
        roles: ["admin"],
        cascadeHint: "Management accepts residual control risk; directive/governance controls cross regulator.",
        fields: [{ key: "exception_reason", label: "Reason for exception", type: "evidence" }] },
      { action: "suspend", label: "Suspend control",
        path: "/api/control-environment-audit/:id/suspend", method: 'POST',
        roles: ["admin"],
        cascadeHint: "Control audit paused pending resolution; can resume from deficiency assessment.",
        fields: [{ key: "suspend_reason", label: "Reason for suspension", type: "evidence" }, { key: "regulator_audit_in_progress", label: "Regulator audit in progress", type: "boolean" }] },
      { action: "initiate-re-test", label: "Initiate re-test", tone: "primary",
        path: "/api/control-environment-audit/:id/initiate-re-test", method: 'POST',
        roles: ["admin"],
        cascadeHint: "Control re-tested after remediation; advances to ToOE test planning." },
    ...
    initiation: {
      ...
      fields: [
        ...
        { key: 'control_classification', label: 'Classification', type: 'enum', options: ['preventive', 'detective', 'corrective', 'directive', 'governance'] },
      ],
    },
  },
  {
  ...
  },
  {
    ...
    eventsTable: null, eventsFk: null,
    actions: [
      { action: "acknowledge_receipt", label: "Acknowledge receipt", tone: "primary",
        path: "/api/carbon-tax-returns/:id/action", method: 'POST', body: { action: "acknowledge_receipt" },
        roles: ["admin", "carbon_fund"],
        cascadeHint: "SARS issued receipt/tracking number for the filed return.",
        fields: [{ key: "sars_submission_ref", label: "SARS submission reference", type: "string" }] },
      { action: "commence_review", label: "Commence review", tone: "primary",
        path: "/api/carbon-tax-returns/:id/action", method: 'POST', body: { action: "commence_review" },
        roles: ["admin", "carbon_fund"],
        cascadeHint: "SARS has begun technical review of the return; may request additional information." },
      { action: "issue_assessment", label: "Issue assessment", tone: "primary",
        path: "/api/carbon-tax-returns/:id/action", method: 'POST', body: { action: "issue_assessment" },
        roles: ["admin", "carbon_fund"],
        cascadeHint: "SARS has completed review and issued final tax assessment (may differ from self-assessed liability).",
        fields: [{ key: "sars_assessment_ref", label: "SARS assessment reference", type: "string" }, { key: "assessment_amount", label: "Assessment amount (ZAR)", type: "number", unit: "ZAR" }] },
...

  {
    ...
    actions: [
      { action: "open-independent-verify", label: "Open for independent verification", tone: "primary",
        path: "/api/audit-chain/:id/open-independent-verify", method: 'POST',
        roles: ["admin"],
        cascadeHint: "Block ready for Byzantine quorum verification (2-of-3 independent verifiers).",
        fields: [{ key: "independent_verifier_count", label: "Independent verifier count", type: "number" }, { key: "notes", label: "Verification notes", type: "evidence" }] },
      { action: "fork", label: "Fork block", tone: "oxide",
        path: "/api/audit-chain/:id/fork", method: 'POST',
        roles: ["admin"],
        cascadeHint: "Non-emergency divergence from main audit chain; creates soft-pause fork state for investigation.",
        fields: [{ key: "fork_reason", label: "Reason for fork", type: "evidence" }, { key: "notes", label: "Additional notes", type: "evidence" }] },
      { action: "emergency-seal", label: "Emergency seal", tone: "oxide",
        path: "/api/audit-chain/:id/emergency-seal", method: 'POST',
        roles: ["admin"],
        cascadeHint: "SIGNATURE hard line: hash-chain break detected — seals block and crosses regulator inbox EVERY tier immediately.",
        fields: [{ key: "signature_chain_break_detected", label: "Signature chain break", type: "boolean" }, { key: "hash_collision_suspected", label: "Hash collision suspected", type: "boolean" }, { key: "fork_reason", label: "Seal reason", type: "evidence" }, { key: "notes", label: "Emergency details", type: "evidence" }] },
...

  {
    ...
    eventsTable: null, eventsFk: null,
    actions: [
      { action: "complete_edd", label: "Complete EDD", tone: "primary",
        path: "/api/kyc-verifications/:id/action", method: 'POST', body: { action: "complete_edd" },
        roles: ["admin", "support"],
        cascadeHint: "Enhanced due diligence concluded; escalate to compliance review.",
        fields: [{ key: "edd_report_ref", label: "EDD report reference", type: "string" }] },
      { action: "approve_conditionally", label: "Approve conditionally", tone: "primary",
        path: "/api/kyc-verifications/:id/action", method: 'POST', body: { action: "approve_conditionally" },
        roles: ["admin", "support"],
        cascadeHint: "KYC approved subject to stated conditions; participant may proceed with conditions in place.",
        fields: [{ key: "conditions_text", label: "Conditions", type: "evidence", required: true }] },
      { action: "lift_conditions", label: "Lift conditions", tone: "primary",
        path: "/api/kyc-verifications/:id/action", method: 'POST', body: { action: "lift_conditions" },
        roles: ["admin", "support"],
        cascadeHint: "All conditions satisfied; KYC fully verified and unrestricted.",
        fields: [{ key: "reason", label: "Basis for lifting conditions", type: "evidence" }] },
      { action: "reinstate", label: "Reinstate", tone: "primary",
        path: "/api/kyc-verifications/:id/action", method: 'POST', body: { action: "reinstate" },
        roles: ["admin", "support"],
        cascadeHint: "Suspension lifted; participant restored to compliance review for potential clearance.",
        fields: [{ key: "reason", label: "Basis for reinstatement", type: "evidence" }] },
      { action: "suspend", label: "Suspend", tone: "oxide",
        path: "/api/kyc-verifications/:id/action", method: 'POST', body: { action: "suspend" },
        roles: ["admin", "support"],
        cascadeHint: "Potential SAR or ongoing CDD concerns; crosses FIC regulator inbox every tier.",
        fields: [{ key: "reason", label: "Suspension reason", type: "evidence", required: true }] },
      { action: "mark_lapsed", label: "Mark lapsed", tone: "oxide",
        path: "/api/kyc-verifications/:id/action", method: 'POST', body: { action: "mark_lapsed" },
        roles: ["admin", "support"],
        cascadeHint: "Non-cooperative entity; failed to submit within SLA deadline; crosses FIC regulator inbox every tier.",
        fields: [{ key: "reason", label: "Lapse reason", type: "evidence", required: true }] },
...

  {
    ...
    actions: [
      { action: "countersign", label: "Countersign pack", tone: "primary",
        path: "/api/regulator-exports/:id/countersign", method: 'POST',
        roles: ["admin", "regulator"],
        cascadeHint: "CFO applies digital signature; pack moves to countersigned and ready for lodgement.",
        fields: [{ key: "mtls_cert_fingerprint", label: "mTLS certificate fingerprint", type: "string" }, { key: "notes", label: "Notes", type: "evidence" }] },
      { action: "get-counterparty-signoff", label: "Get counterparty signoff", tone: "primary",
        path: "/api/regulator-exports/:id/get-counterparty-signoff", method: 'POST',
        roles: ["admin", "regulator"],
        cascadeHint: "CFO obtains formal signoff from external counterparty; pack advances to counterparty_signoff.",
        fields: [{ key: "counterparty_signoff_obtained", label: "Signoff obtained", type: "boolean" }, { key: "notes", label: "Notes", type: "evidence" }] },
      { action: "restate", label: "Restate pack", tone: "primary",
        path: "/api/regulator-exports/:id/restate", method: 'POST',
        roles: ["admin", "regulator"],
  ...
  // W14 — Support ticket chain (SHAPE-A kebab; table support_tickets — no oe_ prefix)
  {
    ...
    initiation: {
      ...
      fields: [
        ...
        { key: 'category', label: 'Category', type: 'enum', required: true, options: ['access', 'billing', 'feature_question', 'bug', 'data_issue', 'compliance', 'other'] },
        { key: 'description', label: 'Description', type: 'string' },
...

  {
    ...
    initiation: {
      ...
      fields: [
        ...
        { key: 'return_type', label: 'Return type', type: 'enum', options: ['annual_standard', 'annual_construction', 'annual_decommission'] },
        { key: 'notes', label: 'Notes', type: 'string' },
      ],
    },
    filters: [
...

  {
    ...
    actions: [
      { action: 'commence_trial_balance', label: 'Commence trial balance', tone: 'primary',
        path: '/api/ipp-annual-audits/:id/action', method: 'PUT', roles: ['admin', 'ipp_developer'],
...

  {
    ...
    actions: [
      { action: 'commence_collection', label: 'Commence collection', tone: 'primary',
        path: '/api/ipp-lc-reports/:id/action', method: 'PUT', roles: ['admin', 'ipp_developer'],
    ...
    initiation: {
      ...
      fields: [
        ...
        { key: 'lc_content_type', label: 'LC content type', type: 'enum', required: true, options: ['goods', 'services', 'labour', 'sed', 'enterprise_dev', 'ownership'] },
      ],
    },
    filters: [
...

  {
    ...
    eventsTable: null, eventsFk: null,
    actions: [
      { action: 'document_cp', label: 'Document CP', tone: 'primary',
...

  {
    ...
    actions: [
      { action: 'index_metadata', label: 'Index metadata',
        path: '/api/ipp/document-control/chain/:id/index-metadata', roles: ['admin', 'ipp_developer'],
        cascadeHint: 'Indexes document metadata.' },
      { action: 'open_revision', label: 'Open revision',
        path: '/api/ipp/document-control/chain/:id/open-revision', roles: ['admin', 'ipp_developer'],
        cascadeHint: 'Opens a new revision.' },
      { action: 'assign_IDC', label: 'Assign IDC',
        path: '/api/ipp/document-control/chain/:id/assign-idc', roles: ['admin', 'ipp_developer'],
        cascadeHint: 'Assigns inter-discipline check.' },
      { action: 'transmit', label: 'Transmit',
        path: '/api/ipp/document-control/chain/:id/transmit', roles: ['admin', 'ipp_developer'],
        cascadeHint: 'Transmits the document.' },
      { action: 'start_review', label: 'Start review',
        path: '/api/ipp/document-control/chain/:id/start-review', roles: ['admin', 'ipp_developer'],
        cascadeHint: 'Begins document review.' },
      { action: 'comment', label: 'Comment',
        path: '/api/ipp/document-control/chain/:id/comment', roles: ['admin', 'ipp_developer'],
        cascadeHint: 'Records review comments.',
        fields: [{ key: 'comments_summary', label: 'Comments summary', type: 'string', required: true }] },
      { action: 'revise', label: 'Revise',
        path: '/api/ipp/document-control/chain/:id/revise', roles: ['admin', 'ipp_developer'],
        cascadeHint: 'Revises against comments.' },
      { action: 'approve', label: 'Approve', tone: 'primary',
        path: '/api/ipp/document-control/chain/:id/approve', roles: ['admin', 'ipp_developer'],
        cascadeHint: 'Approves the document.' },
      { action: 'issue_for_construction', label: 'Issue for construction',
        path: '/api/ipp/document-control/chain/:id/issue-for-construction', roles: ['admin', 'ipp_developer'],
        cascadeHint: 'Issues the document for construction.' },
      { action: 'finalise_as_built', label: 'Finalise as-built',
        path: '/api/ipp/document-control/chain/:id/finalise-as-built', roles: ['admin', 'ipp_developer'],
        cascadeHint: 'Finalises the as-built record.' },
      { action: 'archive', label: 'Archive', tone: 'primary',
        path: '/api/ipp/document-control/chain/:id/archive', roles: ['admin', 'ipp_developer'],
        cascadeHint: 'Archives the document — terminal.' },
      { action: 'reject', label: 'Reject', tone: 'oxide',
        path: '/api/ipp/document-control/chain/:id/reject', roles: ['admin', 'ipp_developer'],
        cascadeHint: 'Rejects the document — terminal.',
        fields: [{ key: 'reject_reason', label: 'Reject reason', type: 'string', required: true }] },
      { action: 'withdraw', label: 'Withdraw', tone: 'oxide',
        path: '/api/ipp/document-control/chain/:id/withdraw', roles: ['admin', 'ipp_developer'],
        cascadeHint: 'Withdraws the document — terminal.',
        fields: [{ key: 'withdraw_reason', label: 'Withdraw reason', type: 'string', required: true }] },
      { action: 'hold', label: 'Hold', tone: 'oxide',
        path: '/api/ipp/document-control/chain/:id/hold', roles: ['admin', 'ipp_developer'],
        cascadeHint: 'Places the document on hold.',
        fields: [{ key: 'hold_reason', label: 'Hold reason', type: 'string', required: true }] },
      { action: 'resume', label: 'Resume',
        path: '/api/ipp/document-control/chain/:id/resume', roles: ['admin', 'ipp_developer'],
        cascadeHint: 'Resumes from hold.' },
    ],
    initiation: {
...

  {
    ...
    actions: [
      { action: "replace", label: "Replace bond", tone: "primary",
        path: "/api/ipp/bonds/:id/replace", method: 'POST',
        roles: ["admin", "support", "ipp_developer"],
        cascadeHint: "Old bond transitions to 'replaced' status; new renewal bond created in 'active' status.",
        fields: [{ key: "bond_number", label: "Bond number", type: "string", required: true }, { key: "issuer", label: "Issuer", type: "string", required: true }, { key: "face_value_zar", label: "Face value", type: "number", required: true, unit: "ZAR" }, { key: "issued_at", label: "Issued at", type: "date", required: true }, { key: "expiry_at", label: "Expiry at", type: "date", required: true }, { key: "beneficiary", label: "Beneficiary", type: "string" }, { key: "release_conditions", label: "Release conditions", type: "string" }] },
      { action: "forfeit", label: "Forfeit bond", tone: "oxide",
        path: "/api/ipp/bonds/:id/forfeit", method: 'POST',
        roles: ["admin", "support"],
        cascadeHint: "Bond transitions to 'forfeited' terminal state; beneficiary receives claim amount (defaults to face value if not specified).",
        fields: [{ key: "claim_amount_zar", label: "Claim amount", type: "number", unit: "ZAR" }, { key: "claim_reason", label: "Reason for forfeiture", type: "evidence" }] },
      { action: 'acknowledge', label: 'Acknowledge',
  ...
  // WRITE: admin | ipp_developer. PUT /:id/action verb-in-body. No quantum column.
  {
    ...
    eventsTable: null, eventsFk: null,
    actions: [
      { action: "appoint_eco", label: "Appoint ECO", tone: "primary",
        path: "/api/ipp-eco-report/:id/action", method: 'PUT', body: { action: "appoint_eco" },
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Environmental Control Officer appointed; site inspection phase begins.",
        fields: [{ key: "eco_name", label: "ECO name", type: "string" }] },
      { action: "commence_site_inspection", label: "Commence site inspection",
        path: "/api/ipp-eco-report/:id/action", method: 'PUT', body: { action: "commence_site_inspection" },
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Site inspection under way; ECO evaluating EA compliance on-site." },
      { action: "complete_site_inspection", label: "Complete site inspection",
        path: "/api/ipp-eco-report/:id/action", method: 'PUT', body: { action: "complete_site_inspection" },
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Site inspection concluded; report drafting phase starts.",
        fields: [{ key: "notes", label: "Inspection notes", type: "evidence" }] },
      { action: "submit_for_review", label: "Submit for review",
        path: "/api/ipp-eco-report/:id/action", method: 'PUT', body: { action: "submit_for_review" },
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Report ready; submitted to DFFE for review.",
        fields: [{ key: "notes", label: "Submission notes", type: "evidence" }] },
      { action: "commence_dffe_review", label: "Commence DFFE review",
        path: "/api/ipp-eco-report/:id/action", method: 'PUT', body: { action: "commence_dffe_review" },
        roles: ["admin", "ipp_developer"],
        cascadeHint: "DFFE/DLME review initiated on submitted report." },
      { action: "raise_queries", label: "Raise queries",
        path: "/api/ipp-eco-report/:id/action", method: 'PUT', body: { action: "raise_queries" },
        roles: ["admin", "ipp_developer"],
        cascadeHint: "DFFE raised clarification queries; IPP must respond.",
        fields: [{ key: "notes", label: "Query details", type: "evidence" }] },
      { action: "submit_responses", label: "Submit responses",
        path: "/api/ipp-eco-report/:id/action", method: 'PUT', body: { action: "submit_responses" },
        roles: ["admin", "ipp_developer"],
        cascadeHint: "IPP submitted responses to DFFE queries; awaiting final determination.",
        fields: [{ key: "notes", label: "Response summary", type: "evidence" }] },
      { action: "commence_corrective_action", label: "Commence corrective action",
        path: "/api/ipp-eco-report/:id/action", method: 'PUT', body: { action: "commence_corrective_action" },
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Non-compliance identified; IPP initiating remediation to restore compliance.",
        fields: [{ key: "notes", label: "Corrective action plan", type: "evidence" }] },
    ...
    initiation: {
      ...
      fields: [
        ...
        { key: 'violation_category', label: 'Violation category', type: 'enum', options: ['none', 'water_management', 'waste_management', 'vegetation_clearing', 'noise_dust', 'heritage_resources', 'biodiversity', 'rehabilitation'] },
      ],
    },
  },
  ...
  // WRITE: admin | ipp_developer. PUT /:id/action verb-in-body. No ZAR quantum (lost MWh).
  {
    ...
    eventsTable: null, eventsFk: null,
    actions: [
      { action: "verify_notice", label: "Verify notice", tone: "primary",
        path: "/api/ipp-fm/:id/action", method: 'PUT', body: { action: "verify_notice" },
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Verifies the formal FM notice was properly served within the contractual deadline." },
      { action: "commence_monitoring", label: "Commence monitoring", tone: "primary",
        path: "/api/ipp-fm/:id/action", method: 'PUT', body: { action: "commence_monitoring" },
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Begins active monitoring of the FM event while relief is in progress." },
      { action: "commence_arbitration", label: "Commence arbitration", tone: "primary",
        path: "/api/ipp-fm/:id/action", method: 'PUT', body: { action: "commence_arbitration" },
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Escalates disputed FM claim to formal arbitration under FIDIC provisions." },
      { action: "determine_arbitration", label: "Determine arbitration", tone: "primary",
        path: "/api/ipp-fm/:id/action", method: 'PUT', body: { action: "determine_arbitration" },
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Closes arbitration with a binding determination; terminal state." },
      { action: "withdraw_claim", label: "Withdraw claim", tone: "oxide",
        path: "/api/ipp-fm/:id/action", method: 'PUT', body: { action: "withdraw_claim" },
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Withdraws the FM claim before arbitration concludes; terminal state." },
  ...
  // WRITE: admin | ipp_developer. PUT /:id/action verb-in-body. No ZAR quantum.
  {
    ...
    eventsTable: null, eventsFk: null,
    actions: [
      { action: "commence_field_survey", label: "Commence field survey", tone: "primary",
        path: "/api/ipp-land-register/:id/action", method: 'PUT', body: { action: "commence_field_survey" },
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Initiates the on-site survey; sets the field-survey timestamp and opens the servitude/diagram workflow." },
      { action: "submit_diagram", label: "Submit diagram", tone: "primary",
        path: "/api/ipp-land-register/:id/action", method: 'PUT', body: { action: "submit_diagram" },
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Submits the as-built diagram for Surveyor-General review." },
      { action: "notarise_servitude", label: "Notarise servitude", tone: "primary",
        path: "/api/ipp-land-register/:id/action", method: 'PUT', body: { action: "notarise_servitude" },
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Records the notarised servitude agreement(s) and opens the deeds-lodging step." },
      { action: "resolve_defective_title", label: "Resolve defective title", tone: "primary",
        path: "/api/ipp-land-register/:id/action", method: 'PUT', body: { action: "resolve_defective_title" },
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Cures the title defect and re-lodges the corrected deed; moves chain back to deeds-lodged pending registration.",
        fields: [{ key: "deeds_reference", label: "Corrected deeds reference", type: "string" }] },
      { action: "raise_defective_title", label: "Raise defective title", tone: "oxide",
        path: "/api/ipp-land-register/:id/action", method: 'PUT', body: { action: "raise_defective_title" },
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Flags a title defect in the deeds office submission; requires cure and re-lodging.",
        fields: [{ key: "reason", label: "Defect reason", type: "evidence", required: true }] },
      { action: "abandon", label: "Abandon", tone: "oxide",
        path: "/api/ipp-land-register/:id/action", method: 'PUT', body: { action: "abandon" },
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Terminates the survey process; closes the chain with no registered title (e.g., project decommissioned or withdrawn).",
        fields: [{ key: "reason", label: "Abandonment reason", type: "evidence", required: true }] },
      { action: "supersede", label: "Supersede", tone: "oxide",
        path: "/api/ipp-land-register/:id/action", method: 'PUT', body: { action: "supersede" },
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Replaces this survey with a new registration; closes the current chain as superseded.",
        fields: [{ key: "reason", label: "Supersession reason", type: "evidence", required: true }] },
  ...
  // WRITE: admin | support | ipp_developer | grid_operator. POST /:id/action verb-in-body (sla_deadline col).
  {
    ...
    eventsTable: null, eventsFk: null,
    actions: [
      { action: "log_notification", label: "Log notification", tone: "primary",
        path: "/api/export-curtailments/:id/action", method: 'POST', body: { action: "log_notification" },
        roles: ["admin", "support", "ipp_developer", "grid_operator"],
        cascadeHint: "Curtailment event logged from SO; ready for energy calculation.",
        fields: [{ key: "reason", label: "Notification details", type: "string" }] },
      { action: "calculate_energy", label: "Calculate energy", tone: "primary",
        path: "/api/export-curtailments/:id/action", method: 'POST', body: { action: "calculate_energy" },
        roles: ["admin", "support", "ipp_developer", "grid_operator"],
        cascadeHint: "Lost generation and deemed-energy quantum computed from metering and irradiance.",
        fields: [{ key: "actual_generation_mwh", label: "Actual generation (MWh)", type: "number", unit: "MWh" }, { key: "deemed_energy_mwh", label: "Deemed energy (MWh)", type: "number", unit: "MWh" }, { key: "irradiance_ghi_kwh_m2", label: "GHI irradiance", type: "number", unit: "kWh/m²" }, { key: "reason", label: "Calculation notes", type: "string" }] },
      { action: "prepare_claim", label: "Prepare claim", tone: "primary",
        path: "/api/export-curtailments/:id/action", method: 'POST', body: { action: "prepare_claim" },
        roles: ["admin", "support", "ipp_developer", "grid_operator"],
        cascadeHint: "Compensation claim document prepared and ready for submission to counterparty.",
        fields: [{ key: "tariff_rate_per_mwh", label: "Tariff rate (ZAR/MWh)", type: "number", unit: "ZAR/MWh" }, { key: "claim_amount_zar", label: "Claim amount (ZAR)", type: "number", unit: "ZAR" }, { key: "reason", label: "Claim basis", type: "string" }] },
      { action: "acknowledge_review", label: "Acknowledge review", tone: "primary",
        path: "/api/export-curtailments/:id/action", method: 'POST', body: { action: "acknowledge_review" },
        roles: ["admin", "support", "ipp_developer", "grid_operator"],
        cascadeHint: "Counterparty is actively reviewing the claim; awaiting settlement or dispute.",
        fields: [{ key: "reason", label: "Review status notes", type: "string" }] },
      { action: "withdraw", label: "Withdraw claim", tone: "oxide",
        path: "/api/export-curtailments/:id/action", method: 'POST', body: { action: "withdraw" },
        roles: ["admin", "support", "ipp_developer", "grid_operator"],
        cascadeHint: "Claim withdrawn by plant operator; terminal state.",
        fields: [{ key: "reason", label: "Withdrawal reason", type: "evidence", required: true }] },
      { action: 'submit_claim', label: 'Submit claim',
  ...
  // W111 — Daily P&L attribution & risk-adjusted returns (restate_pnl crosses on second restatement)
  {
    ...
    actions: [
      { action: "run-mtm", label: "Run MTM", tone: "primary",
        path: "/api/trader/pnl-attribution/chain/:id/run-mtm", method: 'POST',
        roles: ["admin", "trader"],
        cascadeHint: "Mark-to-market snapshot computed; ready for realised P&L calculation.",
        fields: [{ key: "mtm_zar", label: "MTM value (ZAR)", type: "number", unit: "ZAR" }] },
      { action: "compute-realised", label: "Compute realised P&L", tone: "primary",
        path: "/api/trader/pnl-attribution/chain/:id/compute-realised", method: 'POST',
        roles: ["admin", "trader"],
        cascadeHint: "Realised gains/losses captured; ready for unrealised P&L computation.",
        fields: [{ key: "realised_pnl_zar", label: "Realised P&L (ZAR)", type: "number", unit: "ZAR" }] },
      { action: "compute-unrealised", label: "Compute unrealised P&L", tone: "primary",
        path: "/api/trader/pnl-attribution/chain/:id/compute-unrealised", method: 'POST',
        roles: ["admin", "trader"],
        cascadeHint: "Unrealised gains/losses captured; ready for attribution decomposition.",
        fields: [{ key: "unrealised_pnl_zar", label: "Unrealised P&L (ZAR)", type: "number", unit: "ZAR" }] },
      { action: "decompose-attribution", label: "Decompose attribution", tone: "primary",
        path: "/api/trader/pnl-attribution/chain/:id/decompose-attribution", method: 'POST',
        roles: ["admin", "risk_analyst"],
        cascadeHint: "P&L decomposed into delta/gamma/vega/theta/FX/carry/residual; ready for risk decomposition.",
        fields: [{ key: "delta_zar", label: "Delta attribution (ZAR)", type: "number", unit: "ZAR" }, { key: "gamma_zar", label: "Gamma attribution (ZAR)", type: "number", unit: "ZAR" }, { key: "vega_zar", label: "Vega attribution (ZAR)", type: "number", unit: "ZAR" }, { key: "theta_zar", label: "Theta attribution (ZAR)", type: "number", unit: "ZAR" }, { key: "fx_zar", label: "FX attribution (ZAR)", type: "number", unit: "ZAR" }, { key: "carry_zar", label: "Carry attribution (ZAR)", type: "number", unit: "ZAR" }, { key: "residual_zar", label: "Residual (unexplained) P&L (ZAR)", type: "number", unit: "ZAR" }] },
      { action: "decompose-risk", label: "Decompose risk", tone: "primary",
        path: "/api/trader/pnl-attribution/chain/:id/decompose-risk", method: 'POST',
        roles: ["admin", "risk_analyst"],
        cascadeHint: "Risk decomposition (VaR contribution, scenario impact, KRI exceedances) completed; ready for benchmark comparison.",
        fields: [{ key: "var_contribution_zar", label: "VaR contribution (ZAR)", type: "number", unit: "ZAR" }, { key: "scenario_impact_zar", label: "Scenario impact (ZAR)", type: "number", unit: "ZAR" }, { key: "kri_exceedance_count", label: "KRI exceedances", type: "number" }] },
      { action: "compare-to-benchmark", label: "Compare to benchmark", tone: "primary",
        path: "/api/trader/pnl-attribution/chain/:id/compare-to-benchmark", method: 'POST',
        roles: ["admin", "risk_analyst"],
        cascadeHint: "Benchmark comparison (alpha, tracking error, information ratio) and performance ratios (Sharpe, Sortino, max drawdown) computed; ready for review submission.",
        fields: [{ key: "benchmark_return_pct", label: "Benchmark return (%)", type: "number", unit: "%" }, { key: "alpha_pct", label: "Alpha (%)", type: "number", unit: "%" }, { key: "tracking_error_pct", label: "Tracking error (%)", type: "number", unit: "%" }, { key: "sharpe_ratio", label: "Sharpe ratio", type: "number" }, { key: "sortino_ratio", label: "Sortino ratio", type: "number" }, { key: "information_ratio", label: "Information ratio", type: "number" }, { key: "max_drawdown_pct", label: "Max drawdown (%)", type: "number", unit: "%" }] },
      { action: "submit-to-review", label: "Submit to review", tone: "primary",
        path: "/api/trader/pnl-attribution/chain/:id/submit-to-review", method: 'POST',
        roles: ["admin", "risk_analyst"],
        cascadeHint: "Daily P&L attribution package ready for desk head approval or hold." },
      { action: "hold-for-review", label: "Hold for review",
        path: "/api/trader/pnl-attribution/chain/:id/hold-for-review", method: 'POST',
        roles: ["admin", "desk_head"],
        cascadeHint: "P&L held pending further investigation or clarification; desk head awaiting resolution.",
        fields: [{ key: "hold_reason", label: "Hold reason", type: "string" }] },
      { action: "override-hold", label: "Override hold", tone: "primary",
        path: "/api/trader/pnl-attribution/chain/:id/override-hold", method: 'POST',
        roles: ["admin", "desk_head"],
        cascadeHint: "Hold cleared; P&L ready for approval." },
      { action: "reconcile", label: "Reconcile", tone: "primary",
        path: "/api/trader/pnl-attribution/chain/:id/reconcile", method: 'POST',
        roles: ["admin", "finance"],
        cascadeHint: "P&L reconciled against operational books and external sources; ready for archive." },
      { action: "archive-pnl", label: "Archive P&L", tone: "primary",
        path: "/api/trader/pnl-attribution/chain/:id/archive-pnl", method: 'POST',
        roles: ["admin", "finance"],
        cascadeHint: "Daily P&L attribution archived; chain closes (hard terminal). IFRS 13 and GIPS 2020 reporting locked." },
      { action: "flag-variance-investigation", label: "Flag variance investigation",
        path: "/api/trader/pnl-attribution/chain/:id/flag-variance-investigation", method: 'POST',
        roles: ["admin", "risk_analyst"],
        cascadeHint: "Attribution gap ≥ 10% flagged; investigation queued before advancing through risk decomposition.",
        fields: [{ key: "variance_reason", label: "Variance investigation reason", type: "evidence" }] },
  ...
  // W216 — FSCA periodic conduct report (FSCA Conduct Standard 1/2020; verb-in-body)
  {
    ...
    actions: [
      { action: "commence_review", label: "Commence review", tone: "primary",
        path: "/api/fsca-conduct-reports/:id/action", method: 'POST', body: { action: "commence_review" },
        roles: ["admin", "trader", "support"],
        cascadeHint: "Compliance officer initiates internal review — report moves to internal_review state.",
        fields: [{ key: "compliance_officer", label: "Compliance officer name", type: "string" }, { key: "reason", label: "Review reason", type: "evidence" }] },
      { action: "approve_board", label: "Approve board", tone: "primary",
        path: "/api/fsca-conduct-reports/:id/action", method: 'POST', body: { action: "approve_board" },
        roles: ["admin", "trader", "support"],
        cascadeHint: "Board sign-off obtained — report ready for FSCA submission.",
        fields: [{ key: "board_sign_off_date", label: "Board sign-off date", type: "date" }, { key: "board_signatory", label: "Board signatory", type: "string" }, { key: "reason", label: "Approval basis", type: "evidence" }] },
      { action: "record_queries", label: "Record queries", tone: "primary",
        path: "/api/fsca-conduct-reports/:id/action", method: 'POST', body: { action: "record_queries" },
        roles: ["admin", "trader", "support"],
        cascadeHint: "FSCA raised queries — trader must respond.",
        fields: [{ key: "query_summary", label: "Query summary", type: "evidence" }, { key: "reason", label: "Recording notes", type: "evidence" }] },
      { action: "respond_to_queries", label: "Respond to queries", tone: "primary",
        path: "/api/fsca-conduct-reports/:id/action", method: 'POST', body: { action: "respond_to_queries" },
        roles: ["admin", "trader", "support"],
        cascadeHint: "Query responses submitted to FSCA; awaiting acknowledgement.",
        fields: [{ key: "query_response_ref", label: "Response reference", type: "string" }, { key: "reason", label: "Response summary", type: "evidence" }] },
      { action: "reject", label: "Reject", tone: "oxide",
        path: "/api/fsca-conduct-reports/:id/action", method: 'POST', body: { action: "reject" },
        roles: ["admin", "trader", "support"],
        cascadeHint: "FSCA rejected report; crosses regulator inbox. Trader must resubmit.",
        fields: [{ key: "rejection_reason", label: "Rejection reason", type: "evidence" }] },
      { action: "withdraw", label: "Withdraw", tone: "oxide",
        path: "/api/fsca-conduct-reports/:id/action", method: 'POST', body: { action: "withdraw" },
        roles: ["admin", "trader", "support"],
        cascadeHint: "Report withdrawn; period closed or entity deregistered.",
        fields: [{ key: "reason", label: "Withdrawal reason", type: "evidence" }] },
  ...
  // W222 — Cross-border trade & regulatory pre-approval (FMA §17 + SARB ExCon; verb-in-body)
  {
    ...
    eventsTable: null, eventsFk: null,
    actions: [
      { action: "submit_sarb_application", label: "Submit SARB application", tone: "primary",
        path: "/api/cross-border-trades/:id/action", method: 'POST', body: { action: "submit_sarb_application" },
        roles: ["admin", "trader", "support"],
        cascadeHint: "Cross-border trade now under SARB Exchange Control review; parallel to FSCA approval path.",
        fields: [{ key: "sarb_application_ref", label: "SARB application reference", type: "string" }] },
      { action: "fsca_review_commenced", label: "FSCA review commenced",
        path: "/api/cross-border-trades/:id/action", method: 'POST', body: { action: "fsca_review_commenced" },
        roles: ["admin", "trader", "support"],
        cascadeHint: "FSCA has accepted application and begun regulatory review of cross-border transaction." },
      { action: "fsca_grant_approval", label: "FSCA grant approval", tone: "primary",
        path: "/api/cross-border-trades/:id/action", method: 'POST', body: { action: "fsca_grant_approval" },
        roles: ["admin", "trader", "support"],
        cascadeHint: "FSCA approval granted; trade may now proceed to SARB ExCon review or immediately execute if already SARB-approved.",
        fields: [{ key: "fsca_approval_ref", label: "FSCA approval reference", type: "string" }] },
      { action: "withdraw", label: "Withdraw application", tone: "oxide",
        path: "/api/cross-border-trades/:id/action", method: 'POST', body: { action: "withdraw" },
        roles: ["admin", "trader", "support"],
        cascadeHint: "Cross-border trade application withdrawn by trader; all pending approvals forfeited.",
        fields: [{ key: "reason", label: "Withdrawal reason", type: "evidence" }] },
      { action: "sarb_reject", label: "SARB reject", tone: "oxide",
        path: "/api/cross-border-trades/:id/action", method: 'POST', body: { action: "sarb_reject" },
        roles: ["admin", "trader", "support"],
        cascadeHint: "SARB Exchange Control has rejected the cross-border transaction; crosses regulator inbox for every tier.",
        fields: [{ key: "sarb_rejection_reason", label: "SARB rejection basis", type: "evidence" }] },
  ...
  // W232 — ISDA master agreement negotiation (verb-in-body; WRITE {admin, trader})
  {
    ...
    eventsTable: null, eventsFk: null,
    actions: [
      { action: "issue_term_sheet", label: "Issue term sheet", tone: "primary",
        path: "/api/trader/isda-agreement/:id/action", method: 'POST', body: { action: "issue_term_sheet" },
        roles: ["admin", "trader"],
        cascadeHint: "Drafts the initial term sheet for counterparty review.",
        fields: [{ key: "reason_detail", label: "Notes", type: "string" }] },
      { action: "submit_for_counterparty_review", label: "Submit for counterparty review", tone: "primary",
        path: "/api/trader/isda-agreement/:id/action", method: 'POST', body: { action: "submit_for_counterparty_review" },
        roles: ["admin", "trader"],
        cascadeHint: "Sends term sheet to counterparty for their review and feedback.",
        fields: [{ key: "reason_detail", label: "Notes", type: "string" }] },
      { action: "open_negotiation", label: "Open negotiation", tone: "primary",
        path: "/api/trader/isda-agreement/:id/action", method: 'POST', body: { action: "open_negotiation" },
        roles: ["admin", "trader"],
        cascadeHint: "Counterparty review complete; opens formal negotiation phase.",
        fields: [{ key: "reason_detail", label: "Notes", type: "string" }] },
      { action: "agree_credit_terms", label: "Agree credit terms", tone: "primary",
        path: "/api/trader/isda-agreement/:id/action", method: 'POST', body: { action: "agree_credit_terms" },
        roles: ["admin", "trader"],
        cascadeHint: "Commercial terms negotiated and agreed; credit terms finalized.",
        fields: [{ key: "reason_detail", label: "Notes", type: "string" }] },
      { action: "submit_for_legal_review", label: "Submit for legal review", tone: "primary",
        path: "/api/trader/isda-agreement/:id/action", method: 'POST', body: { action: "submit_for_legal_review" },
        roles: ["admin", "trader"],
        cascadeHint: "Agreed terms sent to legal counsel for document review and netting opinion.",
        fields: [{ key: "reason_detail", label: "Notes", type: "string" }] },
      { action: "notify_regulators", label: "Notify regulators", tone: "primary",
        path: "/api/trader/isda-agreement/:id/action", method: 'POST', body: { action: "notify_regulators" },
        roles: ["admin", "trader"],
        cascadeHint: "Legal review complete; regulatory notification sent (crosses regulator inbox for systemic counterparties).",
        fields: [{ key: "reason_detail", label: "Notes", type: "string" }] },
      { action: "request_amendment", label: "Request amendment",
        path: "/api/trader/isda-agreement/:id/action", method: 'POST', body: { action: "request_amendment" },
        roles: ["admin", "trader"],
        cascadeHint: "Active agreement reopened for amendment; amendment number incremented.",
        fields: [{ key: "reason_detail", label: "Amendment basis", type: "evidence", required: true }] },
      { action: "approve_amendment", label: "Approve amendment", tone: "primary",
        path: "/api/trader/isda-agreement/:id/action", method: 'POST', body: { action: "approve_amendment" },
        roles: ["admin", "trader"],
        cascadeHint: "Amendment approved and accepted; agreement returns to active status.",
        fields: [{ key: "reason_detail", label: "Notes", type: "string" }] },
      { action: "suspend", label: "Suspend", tone: "oxide",
        path: "/api/trader/isda-agreement/:id/action", method: 'POST', body: { action: "suspend" },
        roles: ["admin", "trader"],
        cascadeHint: "Agreement temporarily suspended; crosses regulator inbox for all tiers on suspension.",
        fields: [{ key: "reason_code", label: "Suspension reason", type: "string" }, { key: "reason_detail", label: "Details", type: "evidence", required: true }] },
      { action: 'execute_agreement', label: 'Execute agreement',
  ...
  // W188 — Annual compliance assessment (NERSA Grid Code self-assessment; INVERTED SLA; PUT /:id/action verb-in-body)
  {
    ...
    eventsTable: null, eventsFk: null,
    actions: [
      { action: "commence_protection_audit", label: "Commence protection audit", tone: "primary",
        path: "/api/ipp-annual-compliance-assessments/:id/action", method: 'PUT', body: { action: "commence_protection_audit" },
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Starts protection systems audit; initiates the first of six technical compliance domains.",
        fields: [{ key: "notes", label: "Audit notes", type: "string" }] },
      { action: "commence_metering_scada_audit", label: "Commence metering & SCADA audit", tone: "primary",
        path: "/api/ipp-annual-compliance-assessments/:id/action", method: 'PUT', body: { action: "commence_metering_scada_audit" },
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Starts metering and SCADA telemetry audit; validates communication link availability.",
        fields: [{ key: "notes", label: "Audit notes", type: "string" }] },
      { action: "commence_reactive_power_audit", label: "Commence reactive power audit", tone: "primary",
        path: "/api/ipp-annual-compliance-assessments/:id/action", method: 'PUT', body: { action: "commence_reactive_power_audit" },
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Starts reactive power and voltage control audit; reviews VAR capability and voltage steps.",
        fields: [{ key: "notes", label: "Audit notes", type: "string" }] },
      { action: "commence_frequency_response_audit", label: "Commence frequency response audit", tone: "primary",
        path: "/api/ipp-annual-compliance-assessments/:id/action", method: 'PUT', body: { action: "commence_frequency_response_audit" },
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Starts frequency response audit; validates governor deadband and LFSM settings.",
        fields: [{ key: "notes", label: "Audit notes", type: "string" }] },
      { action: "commence_frt_pq_audit", label: "Commence FRT & power quality audit", tone: "primary",
        path: "/api/ipp-annual-compliance-assessments/:id/action", method: 'PUT', body: { action: "commence_frt_pq_audit" },
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Starts Fault Ride-Through and power quality audit per NRS 048-2; reviews harmonics, flicker, unbalance.",
        fields: [{ key: "notes", label: "Audit notes", type: "string" }] },
      { action: "conduct_internal_technical_review", label: "Conduct internal technical review", tone: "primary",
        path: "/api/ipp-annual-compliance-assessments/:id/action", method: 'PUT', body: { action: "conduct_internal_technical_review" },
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Conducts final internal technical review of all six audit domains; prepares package for System Operator submission.",
        fields: [{ key: "notes", label: "Review notes", type: "string" }] },
      { action: "commence_so_review", label: "Commence System Operator review", tone: "primary",
        path: "/api/ipp-annual-compliance-assessments/:id/action", method: 'PUT', body: { action: "commence_so_review" },
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Starts System Operator (NTCSA) technical review; arms the SO SLA window for deficiency notice or acceptance.",
        fields: [{ key: "notes", label: "Notes", type: "string" }] },
  ...
  // W160 — Contractor default & termination (FIDIC 15.2; URGENT tier SLA; PUT /:id/action verb-in-body)
  {
    ...
    eventsTable: null, eventsFk: null,
    actions: [
      { action: "issue_default_notice", label: "Issue default notice",
        path: "/api/ipp-contractor-default/:id/action", method: 'PUT', body: { action: "issue_default_notice" },
        roles: ["admin", "ipp_developer"],
        cascadeHint: "28-day notice period begins; IPP notifies contractor of material default event (FIDIC 15.2).",
        fields: [{ key: "notes", label: "Notification details", type: "evidence" }] },
      { action: "acknowledge_cure_period", label: "Acknowledge cure period",
        path: "/api/ipp-contractor-default/:id/action", method: 'PUT', body: { action: "acknowledge_cure_period" },
        roles: ["admin", "ipp_developer"],
        cascadeHint: "42-day cure window active; contractor has right to remedy default (FIDIC Sub-Clause 15.2.3).",
        fields: [{ key: "notes", label: "Cure acknowledgment", type: "evidence" }] },
      { action: "assess_step_in_rights", label: "Assess step-in rights",
        path: "/api/ipp-contractor-default/:id/action", method: 'PUT', body: { action: "assess_step_in_rights" },
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Evaluate whether lender step-in is required; assess collateral position and remedies available.",
        fields: [{ key: "reason", label: "Assessment rationale", type: "evidence" }] },
      { action: "invoke_step_in_rights", label: "Invoke step-in rights", tone: "primary",
        path: "/api/ipp-contractor-default/:id/action", method: 'PUT', body: { action: "invoke_step_in_rights" },
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Lender assumes control of EPC contract for major+ contracts; crosses regulator inbox (SARB large-exposure).",
        fields: [{ key: "reason", label: "Lender step-in authority", type: "evidence" }] },
      { action: "initiate_bond_call", label: "Initiate bond call",
        path: "/api/ipp-contractor-default/:id/action", method: 'PUT', body: { action: "initiate_bond_call" },
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Activate EPC performance/retention bonds to recover costs; may be parallel with step-in or handover.",
        fields: [{ key: "notes", label: "Bond call justification", type: "evidence" }] },
      { action: "commence_handover", label: "Commence handover",
        path: "/api/ipp-contractor-default/:id/action", method: 'PUT', body: { action: "commence_handover" },
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Begin formal handover of plant and works; contractor obligations cease; prepare for replacement tendering.",
        fields: [{ key: "notes", label: "Handover scope", type: "evidence" }] },
      { action: "award_replacement_contract", label: "Award replacement contract",
        path: "/api/ipp-contractor-default/:id/action", method: 'PUT', body: { action: "award_replacement_contract" },
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Select and contract replacement EPC contractor; competitive tendering concluded; contract execution underway.",
        fields: [{ key: "notes", label: "Award rationale", type: "evidence" }] },
      { action: "withdraw_termination", label: "Withdraw termination", tone: "oxide",
        path: "/api/ipp-contractor-default/:id/action", method: 'PUT', body: { action: "withdraw_termination" },
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Amicably resolve dispute or reinstate contractor; terminates default proceedings without replacement.",
        fields: [{ key: "reason", label: "Withdrawal reason", type: "evidence", required: true }] },
  ...
  // W156 — Change of control (ERA s.11 NERSA consent; regulator co-writes evaluation stages; PUT /:id/action verb-in-body)
  {
    ...
    eventsTable: null, eventsFk: null,
    actions: [
      { action: "commence_completeness", label: "Commence completeness review", tone: "primary",
        path: "/api/ipp-change-of-control/:id/action", method: 'PUT', body: { action: "commence_completeness" },
        roles: ["admin", "ipp_developer", "regulator"],
        cascadeHint: "NERSA officer initiates completeness screening of the filed notification." },
      { action: "withdraw", label: "Withdraw notification", tone: "oxide",
        path: "/api/ipp-change-of-control/:id/action", method: 'PUT', body: { action: "withdraw" },
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Notifying party withdraws the change-of-control notification before final determination.",
        fields: [{ key: "reason", label: "Withdrawal reason", type: "evidence" }] },
    ...
    initiation: {
      ...
      fields: [
        ...
        { key: 'foreign_ownership_flag', label: 'Foreign ownership flag', type: 'enum', options: ['domestic', 'sadc_resident', 'non_sadc_foreign'] },
  ...
  // W190 — EMP compliance report (NEMA AECR; INVERTED SLA; POST /:id/action verb-in-body)
  {
    ...
    eventsTable: null, eventsFk: null,
    actions: [
      { action: "commence_eco_data_collection", label: "Commence ECO data collection", tone: "primary",
        path: "/api/ipp-emp-compliance-reports/:id/action", method: 'POST', body: { action: "commence_eco_data_collection" },
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Environmental Control Officer begins fieldwork inspections of EA conditions.",
        fields: [{ key: "eco_name", label: "ECO name", type: "string" }] },
      { action: "compile_monitoring_results", label: "Compile monitoring results", tone: "primary",
        path: "/api/ipp-emp-compliance-reports/:id/action", method: 'POST', body: { action: "compile_monitoring_results" },
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Consolidate water, air quality, noise, visual and biodiversity monitoring data." },
      { action: "conduct_incident_review", label: "Conduct incident review", tone: "primary",
        path: "/api/ipp-emp-compliance-reports/:id/action", method: 'POST', body: { action: "conduct_incident_review" },
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Review all environmental incidents logged and corrective actions taken.",
        fields: [{ key: "incident_count", label: "Incident count", type: "number" }] },
      { action: "prepare_draft_report", label: "Prepare draft report", tone: "primary",
        path: "/api/ipp-emp-compliance-reports/:id/action", method: 'POST', body: { action: "prepare_draft_report" },
        roles: ["admin", "ipp_developer"],
        cascadeHint: "ECO compiles findings into draft Annual Environmental Compliance Report." },
      { action: "complete_internal_review", label: "Complete internal review", tone: "primary",
        path: "/api/ipp-emp-compliance-reports/:id/action", method: 'POST', body: { action: "complete_internal_review" },
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Project environmental manager and legal complete sign-off on AECR." },
      { action: "obtain_eco_sign_off", label: "Obtain ECO sign-off", tone: "primary",
        path: "/api/ipp-emp-compliance-reports/:id/action", method: 'POST', body: { action: "obtain_eco_sign_off" },
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Independent ECO certifies report meets NEMA standards and EA conditions." },
      { action: "commence_ca_review", label: "Commence CA review", tone: "primary",
        path: "/api/ipp-emp-compliance-reports/:id/action", method: 'POST', body: { action: "commence_ca_review" },
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Competent authority (DFFE/provincial) begins technical assessment and compliance determination." },
  ...
  // W155 — PPA variation (ERA s.35 licence/PPA amendment; INVERTED SLA; PUT /:id/action verb-in-body)
  {
    ...
    eventsTable: null, eventsFk: null,
    actions: [
      { action: "commence_screen", label: "Commence regulatory screening", tone: "primary",
        path: "/api/ipp-ppa-variation/:id/action", method: 'PUT', body: { action: "commence_screen" },
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Variation application enters NERSA regulatory screening phase." },
      { action: "submit_technical", label: "Submit technical review", tone: "primary",
        path: "/api/ipp-ppa-variation/:id/action", method: 'PUT', body: { action: "submit_technical" },
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Technical expert review commissioned; application progresses to technical evaluation phase." },
      { action: "commence_commercial", label: "Commence commercial review", tone: "primary",
        path: "/api/ipp-ppa-variation/:id/action", method: 'PUT', body: { action: "commence_commercial" },
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Commercial expert review commissioned; application proceeds to commercial evaluation phase." },
      { action: "open_public_participation", label: "Open public participation", tone: "primary",
        path: "/api/ipp-ppa-variation/:id/action", method: 'PUT', body: { action: "open_public_participation" },
        roles: ["admin", "ipp_developer"],
        cascadeHint: "NERSA licence amendment published for public consultation per ERA §35 guidelines." },
      { action: "close_public_participation", label: "Close public participation", tone: "primary",
        path: "/api/ipp-ppa-variation/:id/action", method: 'PUT', body: { action: "close_public_participation" },
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Public consultation period closed; application moves to NERSA internal assessment phase." },
      { action: "file_appeal", label: "File appeal", tone: "primary",
        path: "/api/ipp-ppa-variation/:id/action", method: 'PUT', body: { action: "file_appeal" },
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Applicant contests NERSA refusal; case escalates to appeals tribunal (major+material tier only cross regulator).",
        fields: [{ key: "reason", label: "Appeal grounds", type: "evidence" }] },
      { action: "withdraw", label: "Withdraw variation application", tone: "oxide",
        path: "/api/ipp-ppa-variation/:id/action", method: 'PUT', body: { action: "withdraw" },
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Applicant withdraws variation request; chain terminates without NERSA determination.",
        fields: [{ key: "reason", label: "Reason for withdrawal", type: "evidence" }] },
  ...
  // W179 — Performance security (REIPPPP Sched 6 bond renewal; URGENT SLA by bond quantum; PUT /:id/action verb-in-body)
  {
    ...
    actions: [
      { action: "submit_application", label: "Submit Application", tone: "primary",
        path: "/api/ipp-perf-securities/:id/action", method: 'PUT', body: { action: "submit_application" },
        roles: ["admin", "ipp_developer"],
        cascadeHint: "IPP submits bond application to bank for assessment.",
        fields: [{ key: "notes", label: "Notes", type: "evidence" }] },
      { action: "commence_bank_assessment", label: "Commence Bank Assessment", tone: "primary",
        path: "/api/ipp-perf-securities/:id/action", method: 'PUT', body: { action: "commence_bank_assessment" },
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Bank begins technical and financial evaluation of the security package.",
        fields: [{ key: "notes", label: "Notes", type: "evidence" }] },
      { action: "issue_terms", label: "Issue Terms", tone: "primary",
        path: "/api/ipp-perf-securities/:id/action", method: 'PUT', body: { action: "issue_terms" },
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Bank issues binding terms and conditions for the security instrument.",
        fields: [{ key: "notes", label: "Notes", type: "evidence" }] },
      { action: "commence_ipp_review", label: "Commence IPP Review", tone: "primary",
        path: "/api/ipp-perf-securities/:id/action", method: 'PUT', body: { action: "commence_ipp_review" },
        roles: ["admin", "ipp_developer"],
        cascadeHint: "IPP reviews bank terms and prepares response to lender financing gates.",
        fields: [{ key: "notes", label: "Notes", type: "evidence" }] },
      { action: "accept_terms", label: "Accept Terms", tone: "primary",
        path: "/api/ipp-perf-securities/:id/action", method: 'PUT', body: { action: "accept_terms" },
        roles: ["admin", "ipp_developer"],
        cascadeHint: "IPP accepts bank terms; moves to documentation phase.",
        fields: [{ key: "notes", label: "Notes", type: "evidence" }] },
      { action: "prepare_bond_documentation", label: "Prepare Bond Documentation", tone: "primary",
        path: "/api/ipp-perf-securities/:id/action", method: 'PUT', body: { action: "prepare_bond_documentation" },
        roles: ["admin", "ipp_developer"],
        cascadeHint: "Bank and IPP execute all bond / guarantee / LC documents.",
        fields: [{ key: "notes", label: "Notes", type: "evidence" }] },
      { action: "send_dmre_notification", label: "Send DMRE Notification", tone: "primary",
        path: "/api/ipp-perf-securities/:id/action", method: 'PUT', body: { action: "send_dmre_notification" },
        roles: ["admin", "ipp_developer"],
        cascadeHint: "DMRE receives notice of security issuance; PPA performance gate cleared.",
        fields: [{ key: "notes", label: "Notes", type: "evidence" }] },
  ...
  // ({cleared,archived,rejected}): the sweep also excludes manually_cleared + manually_rejected.
  {
    ...
    actions: [
      { action: "verify-kyc", label: "Verify KYC", tone: "primary",
        path: "/api/trader/pretrade-credit/chain/:id/verify-kyc", method: 'POST',
        roles: ["admin", "trader"],
        cascadeHint: "Customer identity verified; advances to credit-line check gate.",
        fields: [{ key: "kyc_verified_at", label: "KYC verification timestamp", type: "date" }, { key: "notes", label: "Notes", type: "evidence" }] },
      { action: "check-credit-line", label: "Check credit line", tone: "primary",
        path: "/api/trader/pretrade-credit/chain/:id/check-credit-line", method: 'POST',
        roles: ["admin", "trader"],
        cascadeHint: "Available credit line verified; utilization computed; advances to settlement-risk gate.",
        fields: [{ key: "credit_line_used_zar", label: "Credit line used", type: "number", unit: "ZAR" }, { key: "credit_line_limit_zar", label: "Credit line limit", type: "number", unit: "ZAR" }, { key: "notes", label: "Notes", type: "evidence" }] },
      { action: "assess-settlement-risk", label: "Assess settlement risk", tone: "primary",
        path: "/api/trader/pretrade-credit/chain/:id/assess-settlement-risk", method: 'POST',
        roles: ["admin", "trader"],
        cascadeHint: "Settlement-risk score (DvP/PvP/currency/tenor) computed; advances to concentration-check gate.",
        fields: [{ key: "dvp_pvp_unavailable", label: "DvP/PvP unavailable", type: "boolean" }, { key: "currency_mismatch", label: "Currency mismatch", type: "boolean" }, { key: "tenor_days", label: "Tenor", type: "number", unit: "days" }, { key: "notes", label: "Notes", type: "evidence" }] },
      { action: "check-concentration", label: "Check concentration", tone: "primary",
        path: "/api/trader/pretrade-credit/chain/:id/check-concentration", method: 'POST',
        roles: ["admin", "trader"],
        cascadeHint: "Single-name concentration ratio verified; advances to halt-status gate.",
        fields: [{ key: "single_name_exposure_zar", label: "Single-name exposure", type: "number", unit: "ZAR" }, { key: "book_value_zar", label: "Book value", type: "number", unit: "ZAR" }, { key: "notes", label: "Notes", type: "evidence" }] },
      { action: "verify-halt-status", label: "Verify halt status", tone: "primary",
        path: "/api/trader/pretrade-credit/chain/:id/verify-halt-status", method: 'POST',
        roles: ["admin", "trader"],
        cascadeHint: "Underlying halt status (none/partial/full) determined; advances to mark-age gate.",
        fields: [{ key: "underlying_halted", label: "Underlying halted", type: "boolean" }, { key: "partial_halt_flag", label: "Partial halt", type: "boolean" }, { key: "notes", label: "Notes", type: "evidence" }] },
      { action: "validate-mark-age", label: "Validate mark age", tone: "primary",
        path: "/api/trader/pretrade-credit/chain/:id/validate-mark-age", method: 'POST',
        roles: ["admin", "trader"],
        cascadeHint: "Mark freshness verified (mark-age <60s bonus); ready for clear-order or hold gate.",
        fields: [{ key: "last_mark_at", label: "Last mark timestamp", type: "date" }, { key: "notes", label: "Notes", type: "evidence" }] },
      { action: "manually-reject", label: "Manually reject", tone: "oxide",
        path: "/api/trader/pretrade-credit/chain/:id/manually-reject", method: 'POST',
        roles: ["admin", "trader"],
        cascadeHint: "Compliance override: order rejected from held_for_review; closes to hard terminal manually_rejected.",
        fields: [{ key: "reject_reason", label: "Rejection reason", type: "evidence" }, { key: "notes", label: "Notes", type: "evidence" }] },
  ...
  // W204 — SLB KPI ratchet (sustainability-linked bond coupon ratchet; POST /:id/action verb-in-body)
  {
    ...
    eventsTable: null, eventsFk: null,
    actions: [
      { action: "start_measurement", label: "Start measurement", tone: "primary",
        path: "/api/slb-kpi-ratchets/:id/action", method: 'POST', body: { action: "start_measurement" },
        roles: ["admin", "offtaker", "support"],
        cascadeHint: "Begins the KPI measurement period; only valid transition from kpi_pending.",
        fields: [{ key: "reason", label: "Notes", type: "string" }] },
      { action: "submit_kpi_data", label: "Submit KPI data", tone: "primary",
        path: "/api/slb-kpi-ratchets/:id/action", method: 'POST', body: { action: "submit_kpi_data" },
        roles: ["admin", "offtaker", "support"],
        cascadeHint: "Submits measured KPI data (meter reading or Solax actuals) for independent verification.",
        fields: [{ key: "kpi_actual_value", label: "Actual KPI value", type: "number" }, { key: "kpi_data_source", label: "Data source", type: "string" }, { key: "reason", label: "Notes", type: "string" }] },
      { action: "request_verification", label: "Request verification", tone: "primary",
        path: "/api/slb-kpi-ratchets/:id/action", method: 'POST', body: { action: "request_verification" },
        roles: ["admin", "offtaker", "support"],
        cascadeHint: "Formally requests independent verifier audit of submitted KPI measurement.",
        fields: [{ key: "reason", label: "Notes", type: "string" }] },
      { action: "calculate_ratchet", label: "Calculate ratchet", tone: "primary",
        path: "/api/slb-kpi-ratchets/:id/action", method: 'POST', body: { action: "calculate_ratchet" },
        roles: ["admin", "offtaker", "support"],
        cascadeHint: "Computes the coupon step (basis points and ZAR amount) based on certified KPI value.",
        fields: [{ key: "ratchet_basis_points", label: "Ratchet (basis points)", type: "number" }, { key: "ratchet_zar", label: "Ratchet amount (ZAR)", type: "number", unit: "ZAR" }, { key: "ratchet_direction", label: "Direction", type: "enum", options: ["up", "down", "flat"] }, { key: "reason", label: "Notes", type: "string" }] },
      { action: "agree_ratchet", label: "Agree ratchet", tone: "primary",
        path: "/api/slb-kpi-ratchets/:id/action", method: 'POST', body: { action: "agree_ratchet" },
        roles: ["admin", "offtaker", "support"],
        cascadeHint: "Counterparties (issuer/bondholder) agree to the calculated coupon ratchet amount.",
        fields: [{ key: "reason", label: "Notes", type: "string" }] },
      { action: "raise_dispute", label: "Raise dispute",
        path: "/api/slb-kpi-ratchets/:id/action", method: 'POST', body: { action: "raise_dispute" },
        roles: ["admin", "offtaker", "support"],
        cascadeHint: "Counterparty disputes the calculated ratchet quantum; enters formal dispute resolution.",
        fields: [{ key: "dispute_ref", label: "Dispute reference", type: "string" }, { key: "dispute_description", label: "Dispute basis", type: "evidence", required: true }, { key: "reason", label: "Notes", type: "string" }] },
      { action: "refer_to_arbitration", label: "Refer to arbitration",
        path: "/api/slb-kpi-ratchets/:id/action", method: 'POST', body: { action: "refer_to_arbitration" },
        roles: ["admin", "offtaker", "support"],
        cascadeHint: "Dispute escalated to external arbitration; crosses JSE + NERSA inbox for all tiers (signature).",
        fields: [{ key: "arbitration_ref", label: "Arbitration reference", type: "string" }, { key: "reason", label: "Notes", type: "string" }] },
      { action: "resolve_arbitration", label: "Resolve arbitration", tone: "primary",
        path: "/api/slb-kpi-ratchets/:id/action", method: 'POST', body: { action: "resolve_arbitration" },
        roles: ["admin", "offtaker", "support"],
        cascadeHint: "Arbitrator resolves the dispute and returns to ratchet_agreed state for final settlement.",
        fields: [{ key: "ratchet_basis_points", label: "Resolved ratchet (basis points)", type: "number" }, { key: "ratchet_zar", label: "Resolved ratchet amount (ZAR)", type: "number", unit: "ZAR" }, { key: "reason", label: "Arbitration outcome", type: "evidence" }] },
  ...
  // lane uses 'safety_grid' (consistent with the grid-compliance surfaces on the IPP board).
  {
    ...
    eventsTable: null, eventsFk: null,
    actions: [
      { action: "confirm_fat", label: "Confirm factory acceptance", tone: "primary",
        path: "/api/smart-meter-assets/:id/action", method: 'POST', body: { action: "confirm_fat" },
        roles: ["admin", "support", "grid_operator", "ipp_developer"],
        cascadeHint: "FAT passed; meter ready for site delivery.",
        fields: [{ key: "fat_certificate_ref", label: "FAT certificate reference", type: "string" }, { key: "reason", label: "Notes", type: "evidence" }] },
      { action: "confirm_delivery", label: "Confirm site delivery", tone: "primary",
        path: "/api/smart-meter-assets/:id/action", method: 'POST', body: { action: "confirm_delivery" },
        roles: ["admin", "support", "grid_operator", "ipp_developer"],
        cascadeHint: "Meter physically received on site; installation can proceed.",
        fields: [{ key: "reason", label: "Delivery confirmation notes", type: "evidence" }] },
      { action: "schedule_installation", label: "Schedule installation", tone: "primary",
        path: "/api/smart-meter-assets/:id/action", method: 'POST', body: { action: "schedule_installation" },
        roles: ["admin", "support", "grid_operator", "ipp_developer"],
        cascadeHint: "Installation slot booked; awaiting PTW and access to cubicle.",
        fields: [{ key: "reason", label: "Scheduling notes", type: "evidence" }] },
      { action: "start_commissioning", label: "Start commissioning", tone: "primary",
        path: "/api/smart-meter-assets/:id/action", method: 'POST', body: { action: "start_commissioning" },
        roles: ["admin", "support", "grid_operator", "ipp_developer"],
        cascadeHint: "Metering firmware configured; current transformers energised.",
        fields: [{ key: "firmware_version", label: "Firmware version loaded", type: "string" }, { key: "commissioning_cert_ref", label: "Commissioning certificate reference", type: "string" }, { key: "reason", label: "Commissioning notes", type: "evidence" }] },
      { action: "confirm_communication", label: "Confirm AMR/AMI connectivity", tone: "primary",
        path: "/api/smart-meter-assets/:id/action", method: 'POST', body: { action: "confirm_communication" },
        roles: ["admin", "support", "grid_operator", "ipp_developer"],
        cascadeHint: "AMR/AMI network connectivity validated; ready for data quality test.",
        fields: [{ key: "reason", label: "Communication test results", type: "evidence" }] },
      { action: "pass_data_quality", label: "Pass data quality check", tone: "primary",
        path: "/api/smart-meter-assets/:id/action", method: 'POST', body: { action: "pass_data_quality" },
        roles: ["admin", "support", "grid_operator", "ipp_developer"],
        cascadeHint: "MDMS confirms NRS 047 data quality criteria satisfied; ready for go-live.",
        fields: [{ key: "data_quality_score", label: "Data quality score (%)", type: "number", unit: "%" }, { key: "reason", label: "Quality assurance notes", type: "evidence" }] },
      { action: "return_to_service", label: "Return to service", tone: "primary",
        path: "/api/smart-meter-assets/:id/action", method: 'POST', body: { action: "return_to_service" },
        roles: ["admin", "support", "grid_operator", "ipp_developer"],
        cascadeHint: "Fault repaired; meter returns to commissioning state for revalidation.",
        fields: [{ key: "reason", label: "Repair and recovery notes", type: "evidence" }] },
  ...
  // W197 — Unserved-energy claim (NRS 048 quality-of-supply compensation; POST /:id/action verb-in-body)
  {
    ...
    actions: [
      ...
      { action: "assess_liability", label: "Assess liability", tone: "primary",
        path: "/api/unserved-energy-claims/:id/action", method: 'POST', body: { action: "assess_liability" },
        roles: ["admin", "grid_operator"],
        cascadeHint: "Determine which party (grid operator or offtaker) bears responsibility for the unserved energy incident.",
        fields: [{ key: "reason", label: "Liability assessment basis", type: "evidence", required: true }] },
      { action: "determine_quantum", label: "Determine quantum", tone: "primary",
        path: "/api/unserved-energy-claims/:id/action", method: 'POST', body: { action: "determine_quantum" },
        roles: ["admin", "grid_operator"],
        cascadeHint: "Calculate the precise financial quantum of compensation; moves claim into formal grid operator response phase.",
        fields: [{ key: "settlement_amount_zar", label: "Quantum (ZAR)", type: "number", unit: "ZAR" }, { key: "reason", label: "Quantum calculation rationale", type: "evidence" }] },
      { action: "enter_negotiation", label: "Enter negotiation", tone: "primary",
        path: "/api/unserved-energy-claims/:id/action", method: 'POST', body: { action: "enter_negotiation" },
        roles: ["admin", "offtaker", "grid_operator"],
        cascadeHint: "Parties transition from formal assessment into bilateral negotiation; enables settlement offer pathway.",
  ...
  // W205 — Demand-response event (NERSA DR programme activation + settlement; POST /:id/action verb-in-body)
  {
    ...
    eventsTable: null, eventsFk: null,
    actions: [
      { action: "send_notification", label: "Send notification", tone: "primary",
        path: "/api/demand-response-events/:id/action", method: 'POST', body: { action: "send_notification" },
        roles: ["admin", "grid_operator", "support"],
        cascadeHint: "Grid operator sends day-ahead or real-time demand response notification to participant.",
        fields: [{ key: "reason", label: "Notification reason", type: "evidence" }] },
      { action: "acknowledge", label: "Acknowledge notification", tone: "primary",
        path: "/api/demand-response-events/:id/action", method: 'POST', body: { action: "acknowledge" },
        roles: ["admin", "grid_operator", "support"],
        cascadeHint: "Participant confirms receipt and willingness to participate in demand response." },
      { action: "confirm_load_shed", label: "Confirm load shed", tone: "primary",
        path: "/api/demand-response-events/:id/action", method: 'POST', body: { action: "confirm_load_shed" },
        roles: ["admin", "grid_operator", "support"],
        cascadeHint: "Participant begins load curtailment; activation window recorded for metering.",
        fields: [{ key: "activation_start", label: "Activation start time", type: "date" }, { key: "activation_end", label: "Activation end time", type: "date" }, { key: "actual_mw_shed", label: "Actual MW shed", type: "number", unit: "MW" }] },
      { action: "close_metering", label: "Close metering window", tone: "primary",
        path: "/api/demand-response-events/:id/action", method: 'POST', body: { action: "close_metering" },
        roles: ["admin", "grid_operator", "support"],
        cascadeHint: "Metering period ends; performance now under independent verification.",
        fields: [{ key: "metering_ref", label: "Metering reference", type: "string" }] },
      { action: "calculate_settlement", label: "Calculate settlement", tone: "primary",
        path: "/api/demand-response-events/:id/action", method: 'POST', body: { action: "calculate_settlement" },
        roles: ["admin", "grid_operator", "support"],
        cascadeHint: "Grid operator calculates incentive payment based on performance measurement and rate.",
        fields: [{ key: "performance_pct", label: "Performance %", type: "number", unit: "%" }, { key: "incentive_amount_zar", label: "Incentive amount", type: "number", unit: "ZAR" }] },
      { action: "agree_settlement", label: "Agree settlement", tone: "primary",
        path: "/api/demand-response-events/:id/action", method: 'POST', body: { action: "agree_settlement" },
        roles: ["admin", "grid_operator", "support"],
        cascadeHint: "Both parties accept settlement amount; ready for payment posting.",
        fields: [{ key: "settlement_ref", label: "Settlement reference", type: "string" }] },
      { action: "dispute_settlement", label: "Dispute settlement", tone: "oxide",
        path: "/api/demand-response-events/:id/action", method: 'POST', body: { action: "dispute_settlement" },
        roles: ["admin", "grid_operator", "support"],
        cascadeHint: "Party disputes calculated settlement; crosses into regulator inbox for resolution.",
        fields: [{ key: "dispute_description", label: "Dispute reason", type: "evidence", required: true }] },
      { action: "resolve_dispute", label: "Resolve dispute", tone: "primary",
        path: "/api/demand-response-events/:id/action", method: 'POST', body: { action: "resolve_dispute" },
        roles: ["admin", "grid_operator", "support"],
        cascadeHint: "Settlement dispute resolved; parties agree to adjusted or original settlement amount.",
        fields: [{ key: "reason", label: "Resolution basis", type: "evidence" }] },
      { action: 'activate', label: 'Activate', tone: 'primary',
  ...
  // W203 — Capital-adequacy report (SARB Basel III ICAAP submission; POST /:id/action verb-in-body)
  {
    ...
    eventsTable: null, eventsFk: null,
    actions: [
      { action: "start_rwa_calc", label: "Start RWA calculation", tone: "primary",
        path: "/api/capital-adequacy-reports/:id/action", method: 'POST', body: { action: "start_rwa_calc" },
        roles: ["admin", "lender", "support"],
        cascadeHint: "Bank begins calculating risk-weighted assets and capital ratios for the reporting period.",
        fields: [{ key: "reason", label: "Notes", type: "string" }] },
      { action: "complete_rwa_calc", label: "Complete RWA calculation", tone: "primary",
        path: "/api/capital-adequacy-reports/:id/action", method: 'POST', body: { action: "complete_rwa_calc" },
        roles: ["admin", "lender", "support"],
        cascadeHint: "RWA calculations finished; bank populates credit risk, market risk, and operational risk components.",
        fields: [{ key: "rwa_credit_risk", label: "RWA credit risk (ZAR)", type: "number", unit: "ZAR" }, { key: "rwa_market_risk", label: "RWA market risk (ZAR)", type: "number", unit: "ZAR" }, { key: "rwa_operational_risk", label: "RWA operational risk (ZAR)", type: "number", unit: "ZAR" }, { key: "rwa_total", label: "Total RWA (ZAR)", type: "number", unit: "ZAR" }, { key: "reason", label: "Notes", type: "string" }] },
      { action: "complete_icaap", label: "Complete ICAAP", tone: "primary",
        path: "/api/capital-adequacy-reports/:id/action", method: 'POST', body: { action: "complete_icaap" },
        roles: ["admin", "lender", "support"],
        cascadeHint: "Internal capital adequacy and stress-test review completed; capital ratios calculated against regulatory minimums.",
        fields: [{ key: "cet1_ratio", label: "CET1 ratio (%)", type: "number", unit: "%" }, { key: "tier1_ratio", label: "Tier 1 ratio (%)", type: "number", unit: "%" }, { key: "total_capital_ratio", label: "Total capital ratio (%)", type: "number", unit: "%" }, { key: "leverage_ratio", label: "Leverage ratio (%)", type: "number", unit: "%" }, { key: "reason", label: "Notes", type: "string" }] },
      { action: "board_approve", label: "Board approve", tone: "primary",
        path: "/api/capital-adequacy-reports/:id/action", method: 'POST', body: { action: "board_approve" },
        roles: ["admin", "lender", "support"],
        cascadeHint: "Board of directors approves the ICAAP and capital-adequacy report before SARB submission.",
        fields: [{ key: "reason", label: "Board approval notes", type: "evidence" }] },
      { action: "sarb_raises_queries", label: "SARB raises queries",
        path: "/api/capital-adequacy-reports/:id/action", method: 'POST', body: { action: "sarb_raises_queries" },
        roles: ["admin", "lender", "support"],
        cascadeHint: "SARB sends information requests or clarifications on the submitted return; bank must respond within SLA.",
        fields: [{ key: "reason", label: "Query detail", type: "evidence" }] },
      { action: "respond_to_queries", label: "Respond to queries", tone: "primary",
        path: "/api/capital-adequacy-reports/:id/action", method: 'POST', body: { action: "respond_to_queries" },
        roles: ["admin", "lender", "support"],
        cascadeHint: "Bank submits formal response to SARB queries and requests for additional information or clarification.",
        fields: [{ key: "reason", label: "Response detail", type: "evidence" }] },
      { action: "flag_remediation", label: "Flag remediation",
        path: "/api/capital-adequacy-reports/:id/action", method: 'POST', body: { action: "flag_remediation" },
        roles: ["admin", "lender", "support"],
        cascadeHint: "SARB identifies capital shortfalls or process gaps; bank must prepare and execute a remediation plan.",
        fields: [{ key: "remediation_description", label: "Remediation required", type: "evidence" }, { key: "remediation_deadline", label: "Remediation deadline", type: "date" }] },
      { action: "start_remediation", label: "Start remediation", tone: "primary",
        path: "/api/capital-adequacy-reports/:id/action", method: 'POST', body: { action: "start_remediation" },
        roles: ["admin", "lender", "support"],
        cascadeHint: "Bank executes agreed remediation plan to address capital shortfalls (e.g. raise capital, reduce RWA, or tighten risk controls).",
        fields: [{ key: "reason", label: "Remediation actions taken", type: "evidence" }] },
      { action: "refile", label: "Refile", tone: "primary",
        path: "/api/capital-adequacy-reports/:id/action", method: 'POST', body: { action: "refile" },
        roles: ["admin", "lender", "support"],
        cascadeHint: "Bank resubmits the capital-adequacy return to SARB after remediation measures have been implemented; crosses regulator inbox on mid-tier and above.",
        fields: [{ key: "reason", label: "Remediation outcome and resubmission notes", type: "evidence" }] },
  ...
  // terminal[] = FSCC_HARD_TERMINALS {filed,refiled,revocation_risk} = the route SLA-sweep NOT IN clause.
  {
    ...
    eventsTable: null, eventsFk: null,
    actions: [
      { action: "open_period", label: "Open reporting period", tone: "primary",
        path: "/api/fsca-compliance-reports/:id/action", method: 'POST', body: { action: "open_period" },
        roles: ["admin", "trader", "support"],
        cascadeHint: "Compliance reporting period opened; data gathering phase begins." },
      { action: "start_drafting", label: "Start drafting", tone: "primary",
        path: "/api/fsca-compliance-reports/:id/action", method: 'POST', body: { action: "start_drafting" },
        roles: ["admin", "trader", "support"],
        cascadeHint: "Data gathered; compliance report draft initiated." },
      { action: "submit_for_internal_review", label: "Submit for internal review", tone: "primary",
        path: "/api/fsca-compliance-reports/:id/action", method: 'POST', body: { action: "submit_for_internal_review" },
        roles: ["admin", "trader", "support"],
        cascadeHint: "Draft submitted to internal review; awaiting compliance approval." },
      { action: "request_co_sign_off", label: "Request co-sign off", tone: "primary",
        path: "/api/fsca-compliance-reports/:id/action", method: 'POST', body: { action: "request_co_sign_off" },
        roles: ["admin", "trader", "support"],
        cascadeHint: "Internal review passed; co-signature requested from compliance officer." },
      { action: "submit_to_fsca", label: "Submit to FSCA", tone: "primary",
        path: "/api/fsca-compliance-reports/:id/action", method: 'POST', body: { action: "submit_to_fsca" },
        roles: ["admin", "trader", "support"],
        cascadeHint: "Co-signed report submitted to FSCA for regulatory review; crosses regulator inbox.",
        fields: [{ key: "fsca_reference", label: "FSCA reference number", type: "string" }, { key: "reason", label: "Submission notes", type: "evidence" }] },
      { action: "respond_to_queries", label: "Respond to FSCA queries", tone: "primary",
        path: "/api/fsca-compliance-reports/:id/action", method: 'POST', body: { action: "respond_to_queries" },
        roles: ["admin", "trader", "support"],
        cascadeHint: "Regulatory queries answered; report ready for final filing decision.",
        fields: [{ key: "query_note", label: "Response summary", type: "evidence" }, { key: "reason", label: "Internal notes", type: "evidence" }] },
      { action: "start_remediation", label: "Start remediation", tone: "primary",
        path: "/api/fsca-compliance-reports/:id/action", method: 'POST', body: { action: "start_remediation" },
        roles: ["admin", "trader", "support"],
        cascadeHint: "Deficiency identified; remediation plan triggered with cure deadline.",
        fields: [{ key: "remediation_plan", label: "Remediation plan", type: "evidence" }, { key: "remediation_deadline", label: "Remediation deadline", type: "date" }, { key: "reason", label: "Internal notes", type: "evidence" }] },
  ...
  // terminal[] = GT_HARD_TERMINALS {disclosed,rejected,withdrawn} = the route SLA-sweep NOT IN clause.
  {
    ...
    eventsTable: null, eventsFk: null,
    actions: [
      { action: "start_eligibility", label: "Start eligibility check", tone: "primary",
        path: "/api/green-tariff-disclosures/:id/action", method: 'POST', body: { action: "start_eligibility" },
        roles: ["admin", "offtaker", "support"],
        cascadeHint: "Initiates the eligibility verification against green-tariff criteria (PPA alignment, REC/GOO sourcing).",
        fields: [{ key: "reason", label: "Reason", type: "string" }] },
      { action: "begin_attribute_matching", label: "Begin attribute matching", tone: "primary",
        path: "/api/green-tariff-disclosures/:id/action", method: 'POST', body: { action: "begin_attribute_matching" },
        roles: ["admin", "offtaker", "support"],
        cascadeHint: "Starts the REC/GOO-to-consumption matching phase; verifier will cross-reference I-REC registry.",
        fields: [{ key: "reason", label: "Reason", type: "string" }] },
      { action: "submit_for_review", label: "Submit for review", tone: "primary",
        path: "/api/green-tariff-disclosures/:id/action", method: 'POST', body: { action: "submit_for_review" },
        roles: ["admin", "offtaker", "support"],
        cascadeHint: "Packages the REC/GOO serial references and match metrics for independent third-party verification.",
        fields: [{ key: "matched_rec_mwh", label: "Matched REC/GOO", type: "number", unit: "MWh" }, { key: "match_percentage", label: "Match percentage", type: "number", unit: "%" }, { key: "rec_serial_from", label: "REC/GOO serial (from)", type: "string" }, { key: "rec_serial_to", label: "REC/GOO serial (to)", type: "string" }, { key: "irec_registry", label: "I-REC registry", type: "string" }, { key: "reason", label: "Reason", type: "string" }] },
      { action: "submit_to_cdp", label: "Submit to CDP/SBTi", tone: "primary",
        path: "/api/green-tariff-disclosures/:id/action", method: 'POST', body: { action: "submit_to_cdp" },
        roles: ["admin", "offtaker", "support"],
        cascadeHint: "Submits the verified disclosure to CDP Climate Change or SBTi target registry for public Scope-2 credit.",
        fields: [{ key: "cdp_submission_ref", label: "CDP submission reference", type: "string" }, { key: "sbti_target_ref", label: "SBTi target reference", type: "string" }, { key: "reason", label: "Reason", type: "string" }] },

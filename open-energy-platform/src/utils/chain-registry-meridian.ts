  ...
  },
  {
    ...
    actions: [
      { action: "log-cr", label: "Log change request", tone: "primary",
        path: "/api/ipp-evm/:id/log-cr", method: 'POST',
        roles: ["admin", "ipp_developer"],
      ...
      { action: "approve-cr", label: "Approve change request", tone: "primary",
        path: "/api/ipp-evm/:id/approve-cr", method: 'POST',
        roles: ["admin", "ipp_developer"],
      ...
      { action: "reject-reforecast", label: "Reject reforecast", tone: "oxide",
        path: "/api/ipp-evm/:id/reject-reforecast", method: 'POST',
        roles: ["admin", "ipp_developer"],
      ...
      { action: "draft-reforecast", label: "Draft reforecast", tone: "primary",
        path: "/api/ipp-evm/:id/draft-reforecast", method: 'POST',
        roles: ["admin"],
      ...
      { action: "draw-contingency", label: "Draw contingency reserve", tone: "primary",
        path: "/api/ipp-evm/:id/draw-contingency", method: 'POST',
        roles: ["admin", "ipp_developer"],
      ...
      { action: "submit-to-pm-review", label: "Submit to PM review",
        path: "/api/ipp-evm/:id/submit-to-pm-review", method: 'POST',
        roles: ["admin", "ipp_developer"],
      ...
      { action: "draw-management-reserve", label: "Draw management reserve", tone: "oxide",
        path: "/api/ipp-evm/:id/draw-management-reserve", method: 'POST',
        roles: ["admin", "ipp_developer"],

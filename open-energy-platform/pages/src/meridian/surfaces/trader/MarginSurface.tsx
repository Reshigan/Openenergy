    ...
    <div className="space-y-3">
      ...
      <ListingTable
        ...
        columns={[
          ...
          { key: 'shortfall_zar', label: 'Shortfall', align: 'right', render: (r) => <span className="text-[var(--oxide-deep)] font-semibold">{Number(r.shortfall_zar || 0).toLocaleString('en-ZA', { style: 'currency', currency: 'ZAR' })}</span> },

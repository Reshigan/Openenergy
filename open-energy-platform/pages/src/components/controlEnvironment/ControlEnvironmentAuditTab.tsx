...
export function ControlEnvironmentAuditTab({ regulatorView }: Props = {}) {
  ...
  return (
    <div style={{ fontSize: 12, color: TX1 }}>
      ...
      {err && (
        <div style={{ marginBottom: 12, borderRadius: 6, border: `1px solid ${BAD}`, background: 'color-mix(in oklab, var(--bad) 15%, var(--s1))', padding: '8px 12px', fontSize: 12, color: BAD }}>{err}</div>
      )}

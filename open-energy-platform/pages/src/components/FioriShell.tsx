...
const BASE_NAV: NavItem[] = [
  ...
  { path: '/ledger/best_execution',                          label: 'Best execution',        icon: 'search',        section: 'Trading' },
  ...
  { path: '/ledger/trade_report',                            label: 'Trade reporting',       icon: 'description',   section: 'Compliance (Trader)' },
  ...
  { path: '/ledger/hse_incident',                            label: 'HSE incidents',         icon: 'health_and_safety', section: 'Construction (IPP)' },
  ...
  { path: '/ledger/problem_record',                            label: 'Problem management',   icon: 'bug_report',    section: 'ITIL Chains' },
  { path: '/ledger/change_request',                            label: 'Change enablement',    icon: 'change_circle', section: 'ITIL Chains' },
  { path: '/ledger/security_remediation',                      label: 'Security remediations',icon: 'security',      section: 'ITIL Chains' },
  { path: '/ledger/warranty_recovery',                         label: 'Warranty recovery',    icon: 'build',         section: 'OEM' },
  { path: '/ledger/spare_parts_provisioning',                  label: 'Spare parts',          icon: 'inventory',     section: 'OEM' },
  ...
  { path: '/ledger/om_work_order',                             label: 'Work orders',          icon: 'build',         section: 'Operations (O&M)' },
  { path: '/ledger/pm_compliance',                             label: 'PM compliance',        icon: 'event_repeat',  section: 'Operations (O&M)' },
  { path: '/ledger/permit_to_work',                            label: 'Permit-to-work',       icon: 'key',           section: 'Operations (O&M)' },
  { path: '/ledger/asset_prognostic',                          label: 'Asset prognostics',    icon: 'psychology',    section: 'Asset Health' },
  { path: '/ledger/availability_guarantee',                    label: 'Availability guarantees',icon:'health_and_safety', section: 'Asset Health' },
  { path: '/ledger/spare_parts_provisioning',                  label: 'Spare parts',          icon: 'inventory',     section: 'Supply Chain' },
  { path: '/ledger/vendor_escalation',                         label: 'Vendor escalation',    icon: 'escalator_warning', section: 'Supply Chain' },
  { path: '/ledger/warranty_claim',                            label: 'Warranty claims',      icon: 'shield',        section: 'Supply Chain' },
  { path: '/ledger/hse_incident',                              label: 'HSE incidents',        icon: 'health_and_safety', section: 'Safety (O&M)' },
  { path: '/ledger/site_commissioning',                        label: 'Site commissioning',   icon: 'electric_bolt', section: 'Safety (O&M)' },

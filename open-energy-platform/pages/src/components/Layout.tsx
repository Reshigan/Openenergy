...
const roleSidebarItems: Record<string, { label: string, path: string, icon: string, section: string }[]> = {
  trader: [
    ...
    { label: 'L5 Ops Console', path: '/ops/l5', icon: 'grid', section: 'primary' },
    ...
    { label: 'Documents', path: '/documents', icon: 'contracts', section: 'risk' },
    { label: 'Passkeys', path: '/settings/passkeys', icon: 'admin', section: 'universal' },
  ...
  ipp_developer: [
    ...
    { label: 'Esums O&M', path: '/esums-om', icon: 'grid', section: 'operations' },
    { label: 'Variation Orders', path: '/ipp/variations', icon: 'contracts', section: 'operations' },
    { label: 'Documents', path: '/documents', icon: 'contracts', section: 'operations' },
  ...
  carbon_fund: [
    ...
    { label: 'Documents', path: '/documents', icon: 'contracts', section: 'clients' },
    { label: 'Passkeys', path: '/settings/passkeys', icon: 'admin', section: 'universal' },
    { label: 'Tools', path: '/cockpit', icon: 'tools', section: 'universal' },
    { label: 'Support', path: '/cockpit', icon: 'support', section: 'universal' },
  ],
  offtaker: [
    ...
    { label: 'Variation Orders', path: '/ipp/variations', icon: 'contracts', section: 'primary' },
    { label: 'Documents', path: '/documents', icon: 'contracts', section: 'primary' },
  ...
  grid_operator: [
    ...
    { label: 'Dispatch', path: '/ops/l5', icon: 'trade', section: 'primary' },
    { label: 'Wheeling', path: '/settlement', icon: 'settlement', section: 'primary' },
    { label: 'Constraints', path: '/ops/l5', icon: 'admin', section: 'primary' },
    { label: 'L5 Ops Console', path: '/ops/l5', icon: 'grid', section: 'operations' },
  ...
  regulator: [
    ...
    { label: 'Market Oversight', path: '/ops/l5', icon: 'marketplace', section: 'primary' },
    { label: 'Investigations', path: '/ops/l5', icon: 'admin', section: 'primary' },
    { label: 'L5 Ops Console', path: '/ops/l5', icon: 'grid', section: 'compliance' },
    { label: 'Submissions Queue', path: '/cockpit', icon: 'contracts', section: 'compliance' },
    { label: 'Audit Trail', path: '/audit', icon: 'admin', section: 'compliance' },
    { label: 'Documents', path: '/documents', icon: 'contracts', section: 'compliance' },
    { label: 'Passkeys', path: '/settings/passkeys', icon: 'admin', section: 'universal' },
    { label: 'Tools', path: '/cockpit', icon: 'tools', section: 'universal' },
    { label: 'Support', path: '/cockpit', icon: 'support', section: 'universal' },
  ],
  admin: [
    ...
    { label: 'Esums O&M', path: '/esums-om', icon: 'grid', section: 'operations' },
    { label: 'Documents', path: '/documents', icon: 'contracts', section: 'operations' },
    { label: 'Settlement Ops', path: '/settlement-ops', icon: 'settlement', section: 'operations' },
    { label: 'Health & Uptime', path: '/cockpit', icon: 'grid', section: 'system' },
    { label: 'Platform Console', path: '/admin/platform-console', icon: 'admin', section: 'system' },
    { label: 'Bulk Ops', path: '/admin/bulk-ops', icon: 'admin', section: 'system' },
    { label: 'API Monitoring', path: '/cockpit', icon: 'admin', section: 'system' },
    { label: 'Compliance', path: '/settings/compliance-admin', icon: 'admin', section: 'compliance' },
    { label: 'PAIA Queue', path: '/admin/paia', icon: 'admin', section: 'compliance' },
    { label: 'Access Logs', path: '/cockpit', icon: 'admin', section: 'security' },
    { label: 'Passkeys', path: '/settings/passkeys', icon: 'admin', section: 'security' },
    { label: 'Tools', path: '/cockpit', icon: 'tools', section: 'universal' },
    { label: 'Support', path: '/cockpit', icon: 'support', section: 'universal' },
  ],
  support: [
    ...
    { label: 'Esums O&M', path: '/esums-om', icon: 'grid', section: 'operations' },
    { label: 'PAIA Queue', path: '/admin/paia', icon: 'admin', section: 'operations' },
    { label: 'Settlement Ops', path: '/settlement-ops', icon: 'settlement', section: 'operations' },

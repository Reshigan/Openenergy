...
export function OfftakerWorkstationPage() {
  ...
  return (
    <WorkstationShell
      ...
      panels={panels}
      tabs={[
        { key: 'ppa_contract', label: 'PPA contracts', group: 'Contracts', body: () => <PpaContractChainTab /> },
        { key: 'tariff_indexation', label: 'Tariff indexation', group: 'Contracts', body: () => <TariffIndexationTab /> },
        ...
        { key: 'ppa_termination', label: 'PPA termination', group: 'Compliance', body: () => <PpaTerminationChainTab /> },

  ...
  return (
    <WorkstationShell
      ...
      tabs={[
        ...
        { key: 'pretrade-credit', label: 'Pre-trade credit & settlement risk', group: 'Trading', body: () => <PreTradeCreditChainTab /> },
        { key: 'pnl-attribution', label: 'Daily P&L attribution', group: 'Trading', body: () => <PnlAttributionChainTab /> },
        ...
        { key: 'market-abuse', label: 'Market surveillance', group: 'Risk', body: () => <MarketAbuseChainTab /> },
        { key: 'counterparty-margin', label: 'Counterparty default', group: 'Risk', body: () => <CounterpartyMarginChainTab /> },
        { key: 'algo-cert', label: 'Algo certification', group: 'Risk', body: () => <AlgoCertChainTab /> },
        { key: 'exceptions', label: 'Post-trade exceptions', group: 'Post-trade', body: ({ onRefresh }) => <ExceptionsTab onRefresh={onRefresh} /> },
        { key: 'trade-allocation', label: 'Trade allocation', group: 'Post-trade', body: () => <TradeAllocationChainTab /> },
        { key: 'settlement-fail', label: 'Settlement fails', group: 'Post-trade', body: () => <SettlementFailChainTab /> },

...
export function ContractDetail() {
  ...
  const downloadPdf = () => {
    ...
    doc.setFontSize(12);
    doc.text('CONSOLIDATED ENERGY COCKPIT — CONTRACT', margin, 30);
    ...
    doc.text(`Generated by Consolidated Energy Cockpit · ${new Date().toISOString().slice(0, 19).replace('T', ' ')} UTC · Jurisdiction: ${data.template?.jurisdiction || 'South Africa'}`, margin, pageHeight - 24);

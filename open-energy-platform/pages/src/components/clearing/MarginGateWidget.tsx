...
export function MarginGateWidget() {
  ...
  return (
    <div className="space-y-4" data-testid="margin-gate-widget">
      ...
      {/* Member table */}
      <div className="rounded-xl border border-ionex-border-100 bg-surface-v2 overflow-hidden" data-testid="margin-gate-table">
        ...
        <table className="w-full text-sm">
          ...
          <tbody>
            {loading ? (
              ...
              <tr key={r.member_id} className="border-t border-ionex-border-100 hover:bg-[var(--s2, #eef2f7)]">
                  ...
                  {canManage && (
                    <div className="flex gap-1">
                      <button type="button"
                        ...
                        className="px-2 py-1 text-xs bg-[var(--s2, #eef2f7)] rounded hover:bg-[var(--border-subtle, #e8ecf0)] disabled:opacity-50"
                      >
                        Recompute
                      </button>
                      <button type="button"

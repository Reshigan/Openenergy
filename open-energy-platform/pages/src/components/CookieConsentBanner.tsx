      ...
      <div className="rounded-xl bg-white border border-[var(--border-subtle, #dde4ec)] shadow-xl p-4">
        <div className="flex items-start gap-2">
          ...
          <div className="flex-1 min-w-0">
            <div className="text-[14px] font-semibold text-[var(--ink, #0f1c2e)]">Privacy &amp; cookies</div>
            <p className="text-[12px] text-[var(--ink-2, #3d4756)] mt-1 leading-snug">
            ...
            <div className="mt-2 space-y-2 text-[12px]">
              <label className="flex items-center gap-2 text-[var(--ink-2, #3d4756)] min-h-[24px]">
          ...
          <button type="button"
            ...
            className="p-2 -mt-1 -mr-1 text-[var(--ink-2, #6b7685)] hover:text-[var(--ink, #0f1c2e)] inline-flex items-center justify-center min-w-[24px] min-h-[24px]"
          >

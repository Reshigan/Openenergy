      ...
      {showCreate && (
        ...
        >
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
            ...
            <div>
              <label className="block text-xs text-[var(--ink-2, #3d4756)] mb-1">CEP Equity % (optional)</label>
              <input
                type="number"
            ...
            <div>
              <label className="block text-xs text-[var(--ink-2, #3d4756)] mb-1">Structure Type *</label>
              <select
            ...
            <div>
              <label className="block text-xs text-[var(--ink-2, #3d4756)] mb-1">Distribution Amount (ZAR, optional)</label>
              <input
                type="number"
            ...
            <div>
              <label className="block text-xs text-[var(--ink-2, #3d4756)] mb-1">Community Dev Spend (ZAR, optional)</label>
              <input
                type="number"
            ...
            <div>
              <label className="block text-xs text-[var(--ink-2, #3d4756)] mb-1">Trustee Name (optional)</label>
              <input
                type="text"
              ...
              {pageItems.map(item => {
                ...
                return (
                  <tr key={item.id} className="border-b hover:bg-[var(--s2, #eef2f7)]">
                    ...
                    <td className="py-2 pr-4 text-xs text-[var(--ink-2, #6b7685)] max-w-[120px] truncate" title={item.trustee_name ?? ''}>
                      {item.trustee_name ?? '—'}
                    </td>
                    <td className="py-2 pr-4">

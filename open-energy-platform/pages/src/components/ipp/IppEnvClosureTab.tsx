...
export function IppEnvClosureTab() {
  ...
  if (!loaded) return (
    <div className="p-6">
      <button onClick={() => load()} className="px-4 py-2 bg-indigo-600 text-white rounded hover:bg-indigo-700 text-sm">Load Env Closure</button>
    </div>
  );
  ...
  return (
    <div className="p-4 space-y-4">
      ...
      <div className="flex flex-wrap gap-2 items-center">
        ...
        <button onClick={() => setShowCreate(true)} className="ml-auto px-3 py-1 bg-indigo-600 text-white rounded text-xs hover:bg-indigo-700">+ New Audit</button>
        ...
        <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center" onClick={() => setShowCreate(false)}>
          <div className="bg-white rounded-xl p-6 w-full max-w-md shadow-xl" onClick={e => e.stopPropagation()}>
            ...
            <div className="flex gap-2 mt-4">
              <button onClick={createRecord} disabled={!form.disturbed_area_ha} className="px-4 py-2 bg-indigo-600 text-white rounded text-sm hover:bg-indigo-700 disabled:opacity-50">Create</button>

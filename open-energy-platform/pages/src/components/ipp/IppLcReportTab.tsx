...
const STATUS_COLORS: Record<string, string> = {
  period_open:              'bg-gray-100 text-gray-500',
      ...
      {showCreate && (
        ...
        >
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
            ...
            <div>
              <label className="block text-xs text-gray-600 mb-1">LC Commitment % *</label>
              <input
                type="number"
                value={formCommitPct}
            ...
            <div>
              <label className="block text-xs text-gray-600 mb-1">SED Commitment (ZAR)</label>
              <input
                type="number"
            ...
            <div>
              <label className="block text-xs text-gray-600 mb-1">LC Content Type *</label>
              <select
            ...
            <div>
              <label className="block text-xs text-gray-600 mb-1">LC Tier *</label>
              <select
                value={formTier}
              ...
              {pageItems.map(item => {
                ...
                return (
                  <tr key={item.id} className="border-b hover:bg-gray-50">
                    ...
                    <td className="py-2 pr-4 text-xs text-gray-700">{item.report_quarter}</td>
                    <td className="py-2 pr-4">
                      <span className={`px-2 py-0.5 rounded text-xs font-medium ${TIER_BADGE_COLORS[item.lc_tier] ?? 'bg-gray-100 text-gray-500'}`}>

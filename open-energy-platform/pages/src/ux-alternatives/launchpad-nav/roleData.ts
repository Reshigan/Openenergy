...
const traderDomains: Domain[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { key: 'benchmark_transition', label: 'Benchmark transition', description: 'LIBOR/JIBAR to ZARONIA migration.' },
    ],
  },
  {
    key: 'post_trade',
    ...
    color: 'oklch(0.42 0.12 140)',
    features: [
      { key: 'settlement', label: 'Settlement', description: 'Daily settlement runs and breaks.' },
...
const carbonDomains: Domain[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { key: 'carbon_trading', label: 'OTC carbon trading', description: 'Spot and forward carbon credit OTC book.' },
    ],
  },
];
...
const gridDomains: Domain[] = [
  {
    ...
    features: [
      ...
      { key: 'black_start_grid', label: 'Black start', description: 'Black-start event log and cost recovery.' },
  ...
  },
  {
    ...
    features: [
      ...
      { key: 'levy_compliance', label: 'Levy compliance', description: 'NERSA levy assessment register.' },
...
const adminDomains: Domain[] = [
  ...
  },
  {
    ...
    color: 'oklch(0.46 0.14 55)',
    features: [
      { key: 'trading', label: 'Trading operations', description: 'Order book health, circuit breakers.' },
      { key: 'settlement_admin', label: 'Settlement operations', description: 'Settlement run triggers and reconciliation.' },
...
const epcDomains: Domain[] = [
  {
    ...
    color: 'oklch(0.42 0.10 250)',
    features: [
      { key: 'submittals', label: 'Submittals', description: 'Drawing and document submittal register.' },
      { key: 'rfis', label: 'RFIs', description: 'Request for information log and responses.' },
      { key: 'change-orders', label: 'Change orders', description: 'Contract change order management.' },

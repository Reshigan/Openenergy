...
const lenderDomains: Domain[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { key: 'covenant_workout', label: 'Covenant workout queue', route: '/lender-suite/workout', description: 'Covenant-breach workout cases (open → investigating → resolved) with inline AI advisor.' },
    ],
  },
  {
    key: 'risk_lender',
  ...
  },
  {
    ...
    features: [
      ...
      { key: 'doc_studio', label: 'Document Studio', description: 'Auto-generate term sheets and information memoranda from project data in submission-ready format. Paid subscription.' },
      { key: 'facility_audit_log', label: 'Facility audit & IFRS9 export', route: '/lender-suite/audit', description: 'L5 tamper-evident audit, IFRS9 export and disbursement reconciliation.' },
      { key: 'strate-swift', label: 'Settlement rails (W124)', description: 'STRATE/SWIFT settlement connectors.' },
      { key: 'sap-oracle-erp', label: 'ERP connectors (W125)', description: 'SAP/Oracle ERP integration.' },
      { key: 'government-filing', label: 'Filing connectors (W126)', description: 'NERSA/SARS government filing connectors.' },
...
const carbonDomains: Domain[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { key: 'doc_studio', label: 'Document Studio', description: 'Auto-generate PDD, MRV, validation and REC issuance documents for Gold Standard / Verra / Pure Earth submission. Paid subscription.' },

...
export default {
  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        sans: ['"IBM Plex Sans"', 'Inter', 'system-ui', '-apple-system', 'BlinkMacSystemFont', 'Segoe UI', 'Arial', 'sans-serif'],
        body: ['"IBM Plex Sans"', 'Inter', 'system-ui', 'sans-serif'],
        display: ['Metropolis', '"IBM Plex Sans"', 'Inter', 'system-ui', 'sans-serif'],
        headline: ['Metropolis', '"IBM Plex Sans"', 'Inter', 'system-ui', 'sans-serif'],
        mono: ['"JetBrains Mono"', '"IBM Plex Mono"', 'Consolas', 'monospace'],
        data: ['"JetBrains Mono"', '"IBM Plex Mono"', 'Consolas', 'monospace'],
      },
      fontSize: {
